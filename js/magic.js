...
$(document).on("click", ".groupselect", function() {
    ...
    var g_domain = $(this).attr("data-g_domain");
	var csrf_cookie = $(this).attr("data-csrf_cookie");

	$.post('app/admin/groups/edit-group-result.php', {action:"add", g_name:gname, g_desc:gdescription, gmembers:gmembers, g_domain:g_domain, csrf_cookie:csrf_cookie}, function(data) {
