...
class Addresses_controller extends Common_api_functions
{
    ...
    public function GET()
    {
        ...
        elseif ($this->_params->id == "first_free") {
            ...
            if ($this->_params->ip_addr == false) {
                ...
                return ["code" => 200, "data" => $this->Addresses->transform_address($this->_params->ip_addr, "dotted")];
            }
        ...
        elseif ($this->_params->id == "tags") {
            ...
            if (@$this->_params->id3 == "addresses") {
                ...
                if ($result === false) {
                    ...
                    return ["code" => 200, "data" => $this->prepare_result($result, "addresses/tags", true, false)];
                }
            }
        ...
        elseif (is_numeric($this->_params->id)) {
            ...
            if (@$this->_params->id2 == "ping") {
                ...
                if ($result == false) {
                    ...
                    return ["code" => 200, "data" => $this->prepare_result($result, $this->_params->controller, true, true)];
                }
            }
        } // ip address ?
        elseif (@$this->_params->id == "search") {
            ...
            // check result
            if ($result === false) {
                $this->Response->throw_exception(200, 'Address not found');
            } else {
                return ["code" => 200, "data" => $this->prepare_result($result, $this->_params->controller, true, true)];
            }
        } // search host ?
        elseif (@$this->_params->id == "search_hostname") {
            ...
            // check result
            if ($result === false) {
                $this->Response->throw_exception(200, 'Hostname not found');
            } else {
                return ["code" => 200, "data" => $this->prepare_result($result, $this->_params->controller, false, false)];
            }
        ...
        elseif (@$this->_params->id == "search_hostbase") {
            ...
            // check result
            if ($result === false) {
                $this->Response->throw_exception(200, 'Host name not found');
            } else {
                return ["code" => 200, "data" => $this->prepare_result($result, $this->_params->controller, false, false)];
            }
    ...
    public function POST()
    {
        ...
        if ($this->_params->id == "first_free") {
            ...
            if ($subnet === false) {
                $this->Response->throw_exception(400, "Invalid subnet identifier");
            }
            if ($subnet->isFull == 1) {
                $this->Response->throw_exception(200, "No free addresses found (subnet is full)");
            }
