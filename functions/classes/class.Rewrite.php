...
class Rewrite
{
     ...
     * @var array
     */
    private $uri_passthroughs = ['app', '?switch=back'];
    ...
    private function create_get_params_api()
    {
        ...
        if (sizeof($this->uri_parts) > 0) {
            foreach ($this->uri_parts as $k => $l) {
                ...
                switch ($k) {
                    case 0  :
                        $this->get_params['app_id'] = $l;
                        break;
                    case 1  :
                        $this->get_params['controller'] = $l;
                        break;
                    case 2  :
                        $this->get_params['id'] = $l;
                        break;
                    case 3  :
                        $this->get_params['id2'] = $l;
                        break;
                    case 4  :
                        $this->get_params['id3'] = $l;
                        break;
                    case 5  :
                        $this->get_params['id4'] = $l;
                        break;
                    default :
                        $this->get_params[$k] = $l;
                        break;
        ...
        if (sizeof($this->uri_parts) > 0) {
            if (in_array($this->uri_parts[0], $this->uri_passthroughs)) {
                ...
                foreach ($this->uri_parts as $k => $l) {
                    ...
                    switch ($k) {
                        case 0  :
                            $this->get_params['page'] = $l;
                            break;
                        case 1  :
                            $this->get_params['section'] = $l;
                            break;
                        case 2  :
                            $this->get_params['subnetId'] = $l;
                            break;
                        case 3  :
                            $this->get_params['sPage'] = $l;
                            break;
                        case 4  :
                            $this->get_params['ipaddrid'] = $l;
                            break;
                        case 5  :
                            $this->get_params['tab'] = $l;
                            break;
                        default :
                            $this->get_params[$k] = $l;
                            break;
