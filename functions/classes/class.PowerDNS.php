...
class PowerDNS extends Common_functions
{
    ...
    {
        try { $this->Database_pdns->connect();} catch (Exception $e) {
            // error
    ...
    public function domain_edit($action, $values)
    {
        ...
        if ($action == "add") {return $this->domain_add($values);} elseif ($action == "edit") {return $this->domain_change($values);} elseif ($action == "delete") {return $this->domain_delete($values);} else {return $this->Result->show("danger", _("Invalid action"), true);}
    }
    ...
    private function domain_add($values)
    {
        ...
        # execute
        try { $this->Database_pdns->insertObject("domains", $values);} catch (Exception $e) {
            // write log
    ...
    private function domain_change($values)
    {
        ...
        # execute
        try { $this->Database_pdns->updateObject("domains", $values);} catch (Exception $e) {
            // write log
    ...
    private function domain_delete($values)
    {
        ...
        # execute
        try { $this->Database_pdns->deleteRow("domains", "id", $values['id']);} catch (Exception $e) {
            // write log
    ...
    {
        # fetch
        try { $res = $this->Database_pdns->getObjects("domains", "id");} catch (Exception $e) {
    ...
    {
        # fetch
        try { $res = $this->Database_pdns->findObjects("domains", "name", "%.arpa", "name", true, true, true);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # cache
    ...
    {
        # fetch
        try { $res = $this->Database_pdns->findObjects("domains", "name", "%.in-addr.arpa", "name", true, true);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # cache
    ...
    {
        # fetch
        try { $res = $this->Database_pdns->findObjects("domains", "name", "%.ip6.arpa", "name", true, true);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # cache
    ...
    public function fetch_domain_by_id($id)
    {
        ...
        # fetch
        try { $domain = $this->Database_pdns->getObject("domains", $id);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
    ...
    {
        # fetch
        try { $domain = $this->Database_pdns->findObjects("domains", "name", $name);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
    ...
    {
        # fetch
        try { $res = $this->Database_pdns->numObjectsFilter("records", "domain_id", $domain_id);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function count_domain_records_by_type($domain_id, $type = "PTR")
    {
        ...
        // fetch
        try { $records = $this->Database_pdns->getObjectsQuery($query, array($domain_id, $type));} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function fetch_all_domain_records($domain_id)
    {
        ...
        // fetch
        try { $records = $this->Database_pdns->getObjectsQuery($query, array($domain_id));} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function fetch_record($record_id)
    {
        ...
        // fetch
        try { $record = $this->Database_pdns->getObject("records", $record_id);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function search_record_domain_type_name($domain_id, $type, $name)
    {
        ...
        // fetch
        try { $records = $this->Database_pdns->getObjectQuery($query, array($domain_id, $type, $name));} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    {
        // fetch
        try { $records = $this->Database_pdns->findObjects("records", $field, $value, $sortField, $sortAsc);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    {
        // fetch
        try { $records = $this->Database_pdns->findObjects("records", "content", $hostname, "content", "asc");} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        // remove not CNAME
    ...
    public function search_unique_ips()
    {
        ...
        // search
        try { $records = $this->Database_pdns->getObjectsQuery($query);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function record_edit($action, $values)
    {
        ...
        # execute based on action
        if ($action == "add") {return $this->add_domain_record($values);} elseif ($action == "edit") {return $this->update_domain_record($values['domain_id'], $values);} elseif ($action == "delete") {return $this->remove_domain_record($values['domain_id'], $values['id']);} else {return $this->Result->show("danger", _("Invalid action"), true);}
    }
    ...
    public function add_domain_record($record, $print_success = true)
    {
        ...
        # execute
        try { $this->Database_pdns->insertObject("records", $record);} catch (Exception $e) {
            // write log
    ...
    public function remove_domain_record_by_id($id)
    {
        ...
        # execute
        try { $this->Database_pdns->deleteRow("records", "id", $id);} catch (Exception $e) {
            // write log
    ...
    public function pdns_remove_ip_and_hostname_records($hostname, $ip)
    {
        ...
        // run
        try { $this->Database_pdns->runQuery($query, array($hostname, $ip));} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        #result
    ...
    {
        # execute
        try { $this->Database_pdns->updateObject("records", $content);} catch (Exception $e) {
            // write log
    ...
    private function update_soa_serial($domain_id, $serial = false)
    {
        ...
        // if not set exit
        if ($soa === false) {return false;} else { $soa = $soa[0];}
     ...
     * @return array
     */
    public function formulate_update_record($domain_id = null, $name = null, $type = null, $content = null, $ttl = null, $prio = null, $disabled = null, $old_date = null)
    {
        // initiate class
        $record = new StdClass();
        // set record details
        if (!is_null($name)) {
            $record->name = $this->validate_record_name($name);
        }
        // record name
        if (!is_null($type)) {
            $record->type = $this->validate_record_type($type);
        }
        // record type
        if (!is_null($content)) {
        ...
        // record content
        if (!is_null($ttl)) {
            $record->ttl = $this->validate_ttl($ttl);
        }
        // ttl validation
        if (!is_null($prio)) {
            $record->prio = $this->validate_prio($prio);
        }
        // priority, default NULL
        $record->change_date = $this->update_record_change_date($domain_id, $old_date); // updates change date
        if (!is_null($disabled)) {
            $record->disabled = $disabled;
        }
        // enables of disables record
        // return record
        return (array) $record;
    }
     ...
     * @return void
     */
    private function update_record_change_date($domain_id = null, $current_date = null)
    {
        // check entire zone for the highest change date
        // execute
        try {
            $sql = "
                SELECT MAX(`change_date`) AS max_change_date
                FROM `records`
                WHERE `domain_id` = :domain_id;
            ";

            $stmt = $this->Database_pdns->getPDO()->prepare($sql, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
            $stmt->execute(array(':domain_id' => $domain_id));
            $max_change_date = $stmt->fetch()['max_change_date'];
        } catch (Exception $e) {
            // write log
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        ...
        if (is_null($max_change_date) || $max_change_date == 0) {
            $change_date = $this->set_default_change_date();
        } else {
            $change_date = $max_change_date + 1;
        }
    ...
    {
        // execute
        try { $this->Database_pdns->runQuery("update `records` set `name` = replace(`name`, ?, ?) where where `domain_id` = ?;", array($old_name, $name, $domain_id));} catch (Exception $e) {
            // write log
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
    ...
    {
        // execute
        try { $this->Database_pdns->runQuery("delete from `records` where `domain_id` = ?;", array($domain_id));} catch (Exception $e) {
            // write log
    ...
    public function get_ptr_zone_name_v4($ip, $mask)
    {
        ...
        // create name
        if ($bits == 1) {return $zone[2] . "." . $zone[1] . "." . $zone[0] . ".in-addr.arpa";} else {return $zone[1] . "." . $zone[0] . ".in-addr.arpa";}
    }
    ...
    {
        // execute
        try { $res = $this->Database_pdns->getObjectQuery("select count(*) as `cnt` from `records` where `domain_id` = ? and `name`=? and `type`=? and `content`=?;", array($domain_id, $name, $type, $content));} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # ok
    ...
    public function record_id_exists($ptr_id = 0)
    {
        ...
        # fetch
        try { $count = $this->Database_pdns->numObjectsFilter("records", "id", $ptr_id);} catch (Exception $e) {
            $this->Result->show("danger", _("Error: ") . $e->getMessage());
            return false;
        }
        # result
    ...
    public function remove_all_ptr_records($domain_id, $indexes = array())
    {
        ...
        // execute
        try { $this->Database_pdns->runQuery($query, $params);} catch (Exception $e) {
            // write log
