<?php
/* set latest version */
define("VERSION", "1.41");									//decimal release version e.g 1.32
/* set latest version */
define("VERSION_VISIBLE", "1.4.1");							//visible version in footer e.g 1.3.2
/* set latest revision */
define("REVISION", "026");									//increment on static content changes (js/css) or point releases to avoid caching issues
