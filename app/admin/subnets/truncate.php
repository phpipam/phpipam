...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default btn-danger" id="subnetTruncateSubmit"
                data-subnetId='<?php print $subnet->id; ?>' data-csrf_cookie="<?php print $csrf; ?>"><i
                    class="fa fa-trash-o"></i> <?php print _('Truncate subnet'); ?></button>
    </div>
