    ...
    <form id="editFolderDetails">
        <table class="editSubnetDetails table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm input-w-250" id="field-description"
                           name="description"
                           value="<?php print $Tools->strip_xss(@$folder_old_details['description']); ?>">
                </td>
            ...
            <tr>
                ...
                <td class="info2"><?php print _('Enter master folder if you want to nest it under existing folder, or select root to create root folder'); ?>
                    !
                </td>
            </tr>
            ...
            if (sizeof($custom_fields) > 0) {
                ...
                foreach ($custom_fields as $field) {
                    ...
                    # set default value !
                    if ($_POST['action'] == "add") {
                        $folder_old_details[$field['name']] = $field['Default'];
                    }
...
<div class="pFooter">
    <div class="btn-group">
        ...
        ?>
        <button class="btn btn-sm btn-default editFolderSubmit <?php if ($_POST['action'] == "delete") print "btn-danger"; else print "btn-success"; ?>">
            <i class="<?php if ($_POST['action'] == "add") {
                print "fa fa-plus";
