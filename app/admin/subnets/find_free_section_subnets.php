    ...
    <form id="search_section_free_subnet">
        <table class="editSubnetDetails table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        <input type="text" class="form-control input-sm mask" name="mask"
                               placeholder="<?php print _('Subnet bitmask'); ?>" value='24'>
            ...
            <tr>
                <td class="middle"></td>
                <td class="text-right">
                    <button class='btn btn-sm btn-default submit_popup'
                            data-script="app/admin/subnets/find_free_section_subnets_result.php"
                            data-result_div="search_section_free_subnet_result"
                            data-form='search_section_free_subnet'><?php print _("Search"); ?></button>
                </td>
                <td class="info2"></td>
            </tr>
