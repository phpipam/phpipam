...
# create csrf token
$csrf = $User->Crypto->csrf_cookie("create", "linkedsubnet");
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default btn-success linkSubnetSave"><i
                    class="fa fa-check"></i> <?php print _('Link'); ?></button>
    </div>
