        ...
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td style="vertical-align:middle">
                    <span class="pull-left" style='margin-right:5px;'> / </span> <input type="text"
                                                                                        class="form-control input-sm input-w-100"
                                                                                        name="newMask">
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default btn-success" id="subnetResizeSubmit"><i
                    class="fa fa-check"></i> <?php print _('Resize subnet'); ?></button>
    </div>
