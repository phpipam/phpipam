    ...
    <form id="sectionEdit" name="sectionEdit">
        ...
        <table class="table table-condensed table-noborder sectionEdit">
            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="text" class='input-xlarge form-control input-sm input-w-250' name="name"
                           value="<?php print $Admin->strip_xss(@$section['name']); ?>"
                           size="30" <?php if ($_POST['action'] == "delete") {
                        print ' readonly ';
                    } ?> placeholder="<?php print _('Section name'); ?>">
                    <!-- hidden -->
            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="text" class='input-xlarge form-control input-sm input-w-250' name="description"
                           value="<?php print $Admin->strip_xss(@$section['description']); ?>"
                           size="30" <?php if ($_POST['action'] == "delete") {
                        print " readonly ";
                    } ?> placeholder="<?php print _('Section description'); ?>">
                </td>
            </tr>
            <!-- Master Subnet -->
            <tr>
                ...
                <td colspan="2">
                    <select name="masterSection"
                            class="form-control input-sm input-w-auto pull-left" <?php if ($_POST['action'] == "delete") print 'disabled="disabled"'; ?>>
                        ...
                        if ($sections !== false) {
                            foreach ($sections as $s) {
                                ...
                                if ($s->masterSection == 0 && $s->id != $_POST['sectionid']) {
                                    if ($s->id == $section['masterSection']) {
                                        print "<option value='$s->id' selected='selected'>$s->name</option>";
                                    } else {
            ...
            <tr>
                ...
                <td colspan="2">
                    <select name="strictMode"
                            class="input-small form-control input-sm input-w-auto pull-left" <?php if ($_POST['action'] == "delete") print 'disabled="disabled"'; ?>>
            ...
            if ($groups) {
                foreach ($groups as $g) {
                    ...
                    if (@$permissions[$g['g_id']] == 1) {
                        print " <input type='radio' name='group$g[g_id]' value='1' checked> ro";
                    } else {
                        print " <input type='radio' name='group$g[g_id]' value='1'> ro";
                    }
                    if (@$permissions[$g['g_id']] == 2) {
                        print " <input type='radio' name='group$g[g_id]' value='2' checked> rw";
                    } else {
                        print " <input type='radio' name='group$g[g_id]' value='2'> rw";
                    }
                    if (@$permissions[$g['g_id']] == 3) {
                        print " <input type='radio' name='group$g[g_id]' value='3' checked> rwa";
                    } else {
                        print " <input type='radio' name='group$g[g_id]' value='3'> rwa";
                    }
                    print "</span>";
                    print "</td>";
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="checkbox">
                            ...
                            <input type="checkbox" name="delegate" class="input-switch"
                                   value="1" <?php print $checked; ?>>
                        </div>
                    </td>
                </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup' <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?> data-script="app/admin/sections/edit-result.php" data-result_div="sectionEditResult"
                data-form='sectionEdit'>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.input-switch').on('switchChange.bootstrapSwitch', function (e, data) {
            ...
            // change
            if (state == true) {
                $("tr.warning2").removeClass("hidden");
            } else {
                $("tr.warning2").addClass("hidden");
            }
        });
    });
</script>