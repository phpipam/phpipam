...
<div class="btn-group" style='margin-bottom:20px;margin-top:10px;'>
    <button class='btn btn-sm btn-default open_popup' data-script='app/admin/sections/edit.php' data-class='700'
            data-action='add'><i class='fa fa-plus'></i> <?php print _('Add section'); ?></button>
    <button class='btn btn-sm btn-default open_popup' data-script='app/admin/sections/edit-order.php' data-class='700'
            data-action='add'><i class='fa fa-tasks'></i> <?php print _('Section order'); ?></button>
</div>
