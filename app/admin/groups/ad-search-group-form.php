...
<div class="pContent">
    ...
    <table class="table table-noborder">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control input-sm" id='dfilter' name="dfilter"
                       placeholder="<?php print _('Enter search filter'); ?>"></td>
        </tr>
        ...
        <tr>
            <td></td>
            <td>
                <button class='btn btn-sm btn-default pull-right' class="form-control input-sm"
                        id="adsearchgroupsubmit"><?php print _('Search'); ?></button>
            </td>
        </tr>
