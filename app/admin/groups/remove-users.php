...
<div class="pContent">
    ...
    <?php } else {
        $Result->show("info", _('No users in this group'), false);
    } ?>
</div>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <?php if (sizeof($existing) > 0) { ?>
            <button class='btn btn-sm btn-success submit_popup' data-script="app/admin/groups/remove-users-result.php"
                    data-result_div="groupRemoveUsersResult"
                    data-form='groupRemoveUsers'><?php print _('Remove selected users'); ?></button>
        <?php } ?>
    </div>
