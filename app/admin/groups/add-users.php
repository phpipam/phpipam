...
<div class="pContent">
    ...
    <?php } else {
        $Result->show("info", _('No available users to add to group'), false);
    } ?>
</div>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <?php if (sizeof($missing) > 0) { ?>
            <button class='btn btn-sm btn-success submit_popup' data-script="app/admin/groups/add-users-result.php"
                    data-result_div="groupAddUsersResult"
                    data-form='groupAddUsers'><?php print _("Add selected users"); ?></button>
        <?php } ?>
    </div>
