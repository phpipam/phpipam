    ...
    <form id="groupEdit" name="groupEdit">
        <table class="groupEdit table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td><input type="text" name="g_name" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$group['g_name']); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
                <td class="info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="g_desc" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$group['g_desc']); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>' data-script="app/admin/groups/edit-group-result.php" data-result_div="groupEditResult"
                data-form='groupEdit'>
