...
if ($_GET['subnetId'] == "1" || $_GET['subnetId'] = "2") {
    ...
    <ul class="nav nav-tabs" style="margin-bottom: 30px;">
        <li role="presentation" <?php if ($_GET['subnetId'] == 1) {
            print "class='active'";
        } ?>><a href="<?php print create_link("administration", "instructions", 1); ?>">User instructions</a></li>
        <li role="presentation" <?php if ($_GET['subnetId'] == 2) {
            print "class='active'";
        } ?>><a href="<?php print create_link("administration", "instructions", 2); ?>">IP request instructions</a></li>
    </ul>
    ...
    <form name="instructions" id="instructionsForm">
        ...
        <textarea style="width:100%;" name="instructions" id="instructions"
                  rows="<?php print $rowcount; ?>"><?php print stripslashes($instructions->instructions); ?></textarea>
