    ...
    <form id="BGPEdit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="peer_name" class="form-control input-sm"
                           placeholder="<?php print _('Peer name'); ?>"
                           value="<?php if (isset($bgp->peer_name)) print $Tools->strip_xss($bgp->peer_name); ?>" <?php print $readonly; ?>>
                    <?php
                    if (($_POST['action'] == "edit") || ($_POST['action'] == "delete")) {
            ...
            if ($User->settings->enableVRF == 1 && $User->get_module_permissions("vrf") > 0) {
                ...
                if ($customers != false) {
                    foreach ($customers as $customer) {
                        if (isset($bgp->customer_id) && $customer->id == $bgp->customer_id) {
            ...
            if ($User->settings->enableCircuits == 1 && $User->get_module_permissions("circuits") > 0) {
                ...
                if ($circuits != false) {
                    foreach ($circuits as $circuit) {
                        if (isset($bgp->circuit_id) && $circuit->id == $bgp->circuit_id) {
                            print '<option value="' . $circuit->id . '" selected>' . $circuit->cid . '</option>';
                        } else {
                            print '<option value="' . $circuit->id . '">' . $circuit->cid . '</option>';
                        }
                    }
                }
            ...
            if ($User->settings->enableVRF == 1 && $User->get_module_permissions("vrf") > 0) {
                ...
                if ($vrfs != false) {
                    foreach ($vrfs as $vrf) {
                        if (isset($bgp->vrf_id) && $vrf->vrfId == $bgp->vrf_id) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="peer_address" class="form-control input-sm"
                           placeholder="<?php print _('Peer address'); ?>"
                           value="<?php if (isset($bgp->peer_address)) print $Tools->strip_xss($bgp->peer_address); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            <tr>
                <td><?php print _('Peer AS'); ?></td>
                <td>
                    <input type="text" name="peer_as" class="form-control input-sm"
                           placeholder="<?php print _('Peer AS'); ?>"
                           value="<?php if (isset($bgp->peer_as)) print $Tools->strip_xss($bgp->peer_as); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="local_address" class="form-control input-sm"
                           placeholder="<?php print _('Local address'); ?>"
                           value="<?php if (isset($bgp->local_address)) print $Tools->strip_xss($bgp->local_address); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            <tr>
                <td><?php print _('Local AS'); ?></td>
                <td>
                    <input type="text" name="local_as" class="form-control input-sm"
                           placeholder="<?php print _('Local AS'); ?>"
                           value="<?php if (isset($bgp->local_as)) print $Tools->strip_xss($bgp->local_as); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="description"
                              class="form-control input-sm" <?php print $readonly; ?>><?php if (isset($bgp->description)) print $bgp->description; ?></textarea>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" data-script="app/admin/routing/edit-bgp-submit.php" data-result_div="BGPEditResult" data-form='BGPEdit'>
