...
<div class="pContent">
    ...
    <div style='margin-top:50px;'></div>
    <h4><?php print _("Map new subnet"); ?></h4>
    <hr>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".add_bgp_mapping", function () {
            ...
            $.post("app/admin/routing/edit-bgp-mapping-submit.php", {
                subnet_id: $(this).attr('data-subnetid'),
                bgp_id: $(this).attr('data-bgp_id'),
                direction: $('select.select-' + curr_id + ' option:selected').val()
            }, function (data) {
