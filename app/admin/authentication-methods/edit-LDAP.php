...
<div class="pContent">
    ...
    if (!in_array("ldap", get_loaded_extensions())) {
        $Result->show("danger", _("ldap extension not enabled in php") . "!<hr>", false);
    }
    ?>
        ...
        <table class="editAuthMethod table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="description" class="form-control input-sm"
                           value="<?php print @$method_settings->description; ?>" <?php print $delete; ?>>
                </td>
            ...
            <tr>
                ...
                <td style="width:250px;">
                    <input type="text" name="domain_controllers" class="form-control input-sm"
                           value="<?php print @$method_settings->params->domain_controllers; ?>" <?php print $delete; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="base_dn" class="form-control input-sm"
                           value="<?php print @$method_settings->params->base_dn; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="users_base_dn" class="form-control input-sm"
                           value="<?php print @$method_settings->params->users_base_dn; ?>" <?php print $delete; ?>>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="uid_attr" class="form-control input-sm"
                           value="<?php print @$method_settings->params->uid_attr; ?>" <?php print $delete; ?>>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select id='ldap_security' name="ldap_security"
                            class="form-control input-sm input-w-auto" <?php print $delete; ?>>
                        <option name="ldap_security" class="form-control input-sm input-w-auto"
                                value="tls" <?php if (@$method_settings->params->ldap_security == 'tls') {
                            print 'selected';
                        } ?>>TLS
                        </option>
                        <option name="ldap_security" class="form-control input-sm input-w-auto"
                                value="ssl" <?php if (@$method_settings->params->ldap_security == 'ssl') {
                            print 'selected';
                        } ?>>SSL
                        </option>
                        <option name="ldap_security" class="form-control input-sm input-w-auto"
                                value="none" <?php if (@$method_settings->params->ldap_security == 'none') {
                            print 'selected';
                        } ?>>None
                        </option>
                    </select>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="ad_port" name="ad_port" class="form-control input-sm input-w-100"
                           value="<?php print @$method_settings->params->ad_port; ?>" <?php print $delete; ?>>
                </td>
                <td class="port info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="adminUsername" class="form-control input-sm" style="margin-bottom:5px;"
                           placeholder="<?php print _('Username'); ?>"
                           value="<?php print @$method_settings->params->adminUsername; ?>" <?php print $delete; ?>>
                </td>
                <td class="info2">
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="adminPassword" class="form-control input-sm"
                           placeholder="<?php print _('Password'); ?>"
                           value="<?php print @$method_settings->params->adminPassword; ?>" <?php print $delete; ?>>
                </td>
                <td class="info2">
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            print "btn-danger";
        } else {
            print "btn-success";
        } ?>' data-script="app/admin/authentication-methods/edit-result.php" data-result_div="editAuthMethodResult"
                data-form='editAuthMethod'>
