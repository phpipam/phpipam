...
<div class="dropdown" style="margin-bottom: 20px;">
    <button class="btn btn-default btn-sm dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="true"><?php print _("Create new:"); ?> <span class="caret"></span>
    </button>
...
<!-- table -->
<table id="userPrint" class="table sorted nosearch table-striped table-top table-auto"
       data-cookie-id-table="admin_authm">
