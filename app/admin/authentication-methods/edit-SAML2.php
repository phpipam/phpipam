    ...
    <form id="editAuthMethod" name="editAuthMethod">
        <table class="editAuthMethod table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <select name="advanced" class="form-control input-sm input-w-auto" <?php print $delete; ?>>
                        <option value="0" <?php if (@$method_settings->params->advanced == 0) {
                            print 'selected';
                        } ?>><?php print _('false'); ?></option>
                        <option value="1" <?php if (@$method_settings->params->advanced == 1) {
                            print 'selected';
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idpissuer" class="form-control input-sm"
                           value="<?php print @$method_settings->params->idpissuer; ?>" <?php print $delete; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idplogin" class="form-control input-sm"
                           value="<?php print @$method_settings->params->idplogin; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idplogout" class="form-control input-sm"
                           value="<?php print @$method_settings->params->idplogout; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idpcertfingerprint" class="form-control input-sm"
                           value="<?php print @$method_settings->params->idpcertfingerprint; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <select name="idpcertalgorithm" class="form-control input-w-auto">
                        ...
                        foreach ($values as $v) {
                            if ($v == @$method_settings->params->idpcertalgorithm) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="idpx509cert" class="form-control input-sm"
                           value="<?php print @$method_settings->params->idpx509cert; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
