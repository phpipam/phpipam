    ...
    <form id="editAuthMethod" name="editAuthMethod">
        <table class="editAuthMethod table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td style="width:250px;">
                    <input type="text" name="hostname" class="form-control input-sm"
                           value="<?php print @$method_settings->params->hostname; ?>" <?php print $delete; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="secret" class="form-control input-sm"
                           value="<?php print @$method_settings->params->secret; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="port" class="form-control input-sm"
                           value="<?php print @$method_settings->params->port; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="suffix" class="form-control input-sm"
                           value="<?php print @$method_settings->params->suffix; ?>" <?php print $delete; ?>>
                </td>
                <td class="base_dn info2">
            ...
            <tr>
                ...
                <td>
                    <select name="timeout" class="form-control input-w-auto">
                        ...
                        $values = [1, 2, 3, 5, 10];
                        foreach ($values as $v) {
                            if ($v == @$method_settings->params->timeout) {
