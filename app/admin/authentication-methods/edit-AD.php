    ...
    <form id="editAuthMethod" name="editAuthMethod">
        <table class="editAuthMethod table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="account_suffix" class="form-control input-sm"
                           value="<?php print @$method_settings->params->account_suffix; ?>" <?php print $delete; ?>>
                </td>
                <td class="info2">
            ...
            <tr>
                ...
                <td>
                    <select name="use_ssl" class="form-control input-sm input-w-auto" <?php print $delete; ?>>
                        <option value="0" <?php if (@$method_settings->params->use_ssl == 0) {
                            print 'selected';
                        } ?>><?php print _('false'); ?></option>
                        <option value="1" <?php if (@$method_settings->params->use_ssl == 1) {
                            print 'selected';
                        } ?>><?php print _('true'); ?></option>
                    </select>
                </td>
                <td class="info2">
            ...
            <tr>
                ...
                <td>
                    <select name="use_tls" class="form-control input-sm input-w-auto" <?php print $delete; ?>>
                        <option value="0" <?php if (@$method_settings->params->use_tls == 0) {
                            print 'selected';
                        } ?>><?php print _('false'); ?></option>
                        <option value="1" <?php if (@$method_settings->params->use_tls == 1) {
                            print 'selected';
                        } ?>><?php print _('true'); ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ad_port" class="form-control input-sm input-w-100"
