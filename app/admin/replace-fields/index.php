...
<form id="searchReplace">
    <table class="table" style="width:auto">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="search" class="form-control input-sm"
                       placeholder="<?php print _('search string'); ?>">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="replace" class="form-control input-sm"
                       placeholder="<?php print _('replace string'); ?>">
            </td>
        </tr>
        ...
        <tr class="th">
            <td></td>
            <td>
                <button class="btn btn-sm btn-default" id="searchReplaceSave"><i
                            class="fa fa-check"></i> <?php print _('Replace'); ?></button>
            </td>
        </tr>
