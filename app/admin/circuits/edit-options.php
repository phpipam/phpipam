	...
	<tr>
		...
		<td>
			<select name="pattern"  <?php print $readonly; ?>>
				<option <?php if(isset($POST->pattern) && $POST->pattern == 'Solid'){ print 'selected'; }?>>Solid</option>
				<option <?php if(isset($POST->pattern) && $POST->pattern == 'Dotted'){ print 'selected'; }?>>Dotted</option>
			</select>
		</td>
	</tr>
