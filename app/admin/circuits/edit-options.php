    ...
    <form id="circuit-option-edit" name="circuit-option-edit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="option" class="form-control input-sm"
                           placeholder="<?php print _('New Option'); ?>"
                           value="<?php if (isset($_POST['value'])) print $_POST['value']; ?>" <?php print $readonly; ?>>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="color" name="color" id="color-picker" class="form-control input-sm"
                           placeholder="<?php print _('Hex Color (ex. #000000)'); ?>"
                           value="<?php if (isset($_POST['color'])) print $_POST['color']; ?>" <?php print $readonly; ?>>
            ...
            <tr>
                ...
                <td>
                    <select name="pattern" <?php print $readonly; ?>>
                        <option <?php if (isset($_POST['pattern']) && $_POST['pattern'] == 'Solid') {
                            print 'selected';
                        } ?>>Solid
                        </option>
                        <option <?php if (isset($_POST['pattern']) && $_POST['pattern'] == 'Dotted') {
                            print 'selected';
                        } ?>>Dotted
                        </option>
                    </select>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <a class="btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            print "btn-danger";
        } else {
            print "btn-success";
        } ?>" data-script="app/admin/circuits/edit-options-submit.php" data-result_div="circuit-option-edit-result"
           data-form='circuit-option-edit'>
...
<link rel="stylesheet" type="text/css"
      href="css/bootstrap/bootstrap-colorpicker.min.css?v=<?php print SCRIPT_PREFIX; ?>">
