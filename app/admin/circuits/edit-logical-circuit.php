...
# ID must be numeric
if ($_POST['action'] != "add" && !is_numeric($_POST['circuitid'])) {
...
<div class="pContent">
    ...
    <form id="circuitManagementEdit">
        ...
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="logical_cid" style='width:200px;' class="form-control input-sm"
                           placeholder="<?php print _('ID'); ?>"
                           value="<?php if (isset($logical_circuit->logical_cid)) print $Tools->strip_xss($logical_circuit->logical_cid); ?>" <?php print $readonly; ?>>
                    <?php
                    if (($_POST['action'] == "edit") || ($_POST['action'] == "delete")) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="purpose" style='width:200px;' class="form-control input-sm"
                           placeholder="<?php print _('Purpose'); ?>"
                           value="<?php if (isset($logical_circuit->purpose)) print $Tools->strip_xss($logical_circuit->purpose); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="comments"
                              class="form-control input-sm" <?php print $readonly; ?>><?php if (isset($logical_circuit->comments)) print $logical_circuit->comments; ?></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <p id="duplicate_error" style="display:none" class='alert alert-danger'>Duplicate circuits have been
                        found. Please remove! Reordering will be affected.</p>
                </td>
            </tr>
    ...
    <p style='margin-bottom:0px;margin-top:50px;'><strong><?php print _("Logical circuit physical members"); ?>
            :</strong></p>
...
<!-- All circuit table -->
<div class="pContent" style="<?php if ($_POST['action'] == "delete") {
    echo "display:none;";
} ?>; padding-top:50px;">
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" data-script="app/admin/circuits/edit-logical-circuit-submit.php"
                data-result_div="circuitManagementEditResult" data-form='circuitManagementEdit'>
