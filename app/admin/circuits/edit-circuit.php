    ...
    <form id="circuitManagementEdit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cid" style='width:200px;' class="form-control input-sm"
                           placeholder="<?php print _('ID'); ?>"
                           value="<?php if (isset($circuit->cid)) print $Tools->strip_xss($circuit->cid); ?>" <?php print $readonly; ?>>
                    <?php
                    if (($_POST['action'] == "edit") || ($_POST['action'] == "delete")) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="capacity" style='width:200px;' class="form-control input-sm"
                           placeholder="<?php print _('Capacity'); ?>"
                           value="<?php if (isset($circuit->capacity)) print $Tools->strip_xss($circuit->capacity); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            if ($User->settings->enableCustomers == 1 && $User->get_module_permissions("customers") > 0) {
                ...
                if ($customers != false) {
                    foreach ($customers as $customer) {
                        if ($customer->id == $circuit->customer_id) {
            ...
            <tr>
                ...
                <td>
                    <textarea name="comment"
                              class="form-control input-sm" <?php print $readonly; ?>><?php if (isset($circuit->comment)) print $circuit->comment; ?></textarea>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" data-script="app/admin/circuits/edit-circuit-submit.php" data-result_div="circuitManagementEditResult"
                data-form='circuitManagementEdit'>
