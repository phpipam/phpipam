...
# ID must be numeric
if ($_POST['action'] != "add" && !is_numeric($_POST['providerid'])) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" class="form-control input-sm" placeholder="<?php print _('Name'); ?>"
                           value="<?php if (isset($provider->name)) print $Tools->strip_xss($provider->name); ?>" <?php print $readonly; ?>>
                    <?php
                    if (($_POST['action'] == "edit") || ($_POST['action'] == "delete")) {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="description" class="form-control input-sm"
                           ...
                           value="<?php if (isset($provider->description)) print $Tools->strip_xss($provider->description); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="contact" class="form-control input-sm"
                           placeholder="<?php print _('Contact'); ?>"
                           value="<?php if (isset($provider->contact)) print $Tools->strip_xss($provider->contact); ?>" <?php print $readonly; ?>>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" data-script="app/admin/circuits/edit-provider-submit.php" data-result_div="providerManagementEditResult"
                data-form='providerManagementEdit'>
