...
<div class="pFooter">
    <div class="btn-group">
        ...
        <?php if ($m > 0) { ?>
            <button class='btn btn-sm btn-default submit_popup' data-script="app/admin/vlans/move-vlan-result.php"
                    data-result_div="moveVLANSubmitResult" data-form='moveVLAN'><?php print ("Move"); ?></button>
        <?php } ?>
    </div>
