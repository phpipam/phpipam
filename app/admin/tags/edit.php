            ...
            <tr>
                ...
                <td>
                    <input type="text" name="type" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$tag->type); ?>"
                           maxlength='32' <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
            ...
            <tr>
                ...
                <td>
                    <select name="showtag" class="form-control input-sm input-w-auto">
                        ...
                        <option value="1" <?php if (@$tag->showtag == 1) {
            ...
            <tr>
                ...
                <td>
                    <div class="input-group select-bgcolor">
                        <input type="text" name="bgcolor" class="form-control input-xs"
                               value="<?php print $Admin->strip_xss(@$tag->bgcolor); ?>"
                               maxlength='32' <?php if ($_POST['action'] == "delete") print "readonly"; ?>><span
            ...
            <tr>
                ...
                <td>
                    <div class="input-group select-fgcolor">
                        <input type="text" name="fgcolor" class="form-control input-sm"
                               value="<?php print $Admin->strip_xss(@$tag->fgcolor); ?>"
                               maxlength='32' <?php if ($_POST['action'] == "delete") print "readonly"; ?>><span
                                class="input-group-addon"><i></i></span>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="compress" class="form-control input-sm input-w-auto">
                        ...
                        <option value="Yes" <?php if (@$tag->compress == "Yes") {
                            print "selected='selected'";
                        } ?>><?php print _("Yes"); ?></option>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="updateTag" class="form-control input-sm input-w-auto">
                        <option value="0"><?php print _("No"); ?></option>
                        <option value="1" <?php if (@$tag->updateTag == "1") {
                            print "selected='selected'";
                        } ?>><?php print _("Yes"); ?></option>
                    </select>
                </td>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editTypesubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
