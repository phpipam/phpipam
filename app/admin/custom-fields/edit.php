    ...
    <form id="editCustomFields">
        <table id="editCustomFields" class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" class="form-control input-sm"
                           value="<?php print $Tools->print_custom_field_name($_POST['fieldName']); ?>"
                           placeholder="<?php print _('Select field name'); ?>" <?php if ($_POST['action'] == "delete") {
                        print 'readonly';
                    } ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="Comment" class="form-control input-sm"
                           value="<?php print @$fieldval['Comment']; ?>"
                           placeholder="<?php print _('Enter comment for users'); ?>" <?php if ($_POST['action'] == "delete") {
                        print 'readonly';
                    } ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                $oldMSize = str_replace(["(", ")"], "", strstr(@$fieldval['Type'], "(", false));
                
                //exceptions
                if (@$fieldval['Type'] == "text" || @$fieldval['Type'] == "date" || @$fieldval['Type'] == "datetime" || @$fieldval['Type'] == "set" || @$fieldval['Type'] == "enum") {
                    $oldMType = @$fieldval['Type'];
                }
                ?>
                <td>
                    <select name="fieldType" class="input-sm input-w-auto form-control">
                        ...
                        foreach ($mTypes as $name => $type) {
                            ...
                            } elseif ($type == "bool" && $oldMType == "tinyint") {
                                print "<option value='$type' selected='selected'>$name</option>";
                            } else {
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="fieldSize" class="form-control input-sm"
                           value="<?php print htmlentities(@$oldMSize); ?>"
                           placeholder="<?php print _('Enter field length'); ?>" <?php if ($_POST['action'] == "delete") {
                        print 'readonly';
                    } ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="fieldDefault" class="form-control input-sm"
                           value="<?php print @$fieldval['Default']; ?>"
                           placeholder="<?php print _('Enter default value'); ?>" <?php if ($_POST['action'] == "delete") {
                        print 'readonly';
                    } ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input name="NULL" type="checkbox"
                           value="NO" <?php if (@$fieldval['Null'] == "NO") print "checked"; ?>>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editcustomSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
