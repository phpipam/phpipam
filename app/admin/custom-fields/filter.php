...
isset($filters[$_POST['table']]) ?: $filters[$_POST['table']] = [];
    ...
    <form id="editCustomFieldsFilter">
        <table id="editCustomFields" class="table table-noborder table-condensed">
            ...
            foreach ($custom as $k => $c) {
                ...
                if (in_array($k, $filters[$_POST['table']])) {
                    print "<input type='checkbox' class='input-switch' name='$kNew' checked>";
                } else {
                    print "<input type='checkbox' class='input-switch' name='$kNew'>";
                }
                print "	</td>";
                # remove custom_
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default " id="editcustomFilterSubmit"><i
                    class="fa fa-check"></i> <?php print ucwords(_("Save filter")); ?></button>
    </div>
    <!-- result -->
