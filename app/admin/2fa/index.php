    ...
    <form name="2fa" id="2fa">
        <table id="2fa" class="table table-hover table-condensed table-noborder table-auto table-top">
            ...
            <tr>
                ...
                <td>
                    <select name="2fa_provider" class="form-control input-sm input-w-auto">
                        ...
                        <option value="Google_Authenticator" <?php if ($User->settings->{'2fa_provider'} == "Google_Authenticator") {
                            print "selected";
                        } ?>><?php print _("Google Authenticator"); ?></option>
                    </select>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="2fa_name"
                           value="<?php print $settings->{'2fa_name'}; ?>">
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="2fa_length"
                           value="<?php print $settings->{'2fa_length'}; ?>">
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" class="input-switch" value="1"
                           name="2fa_userchange" <?php if ($settings->{'2fa_userchange'} == 1) print 'checked'; ?>>
                </td>
            ...
            <tr>
                ...
                <td class="info2"><?php print _('Force all users to use 2fa on next login or disable 2fa for all users'); ?>
                    .
                </td>
            </tr>
            ...
            <tr class="th">
                ...
                <td class="submit">
                    <input type="submit" class="btn btn-default btn-success btn-sm submit_popup"
                           data-script="app/admin/2fa/save.php" data-result_div="2faEdit" data-form='2fa'
                           value="<?php print _("Save"); ?>">
                </td>
                <td></td>
            </tr>
...
if (($User->settings->{'2fa_provider'} == "none")) {
    ...
    foreach ($twofa_users as $u) {
        ...
        $status = "";
        if ($u->{'2fa'} == 0) {
            $status = "<span class='badge badge1 severity2'>Disabled</span>";
            $btn2_class = "disabled";
            $btn3_class = "disabled";
        } elseif (strlen($u->{'2fa_secret'}) == 0) {
            $status = "<span class='badge badge1 severity1'>Enabled, not activated</span>";
            $btn1_class = "disabled";
            $btn2_class = "disabled";
        } else {
            $status = "<span class='badge badge1 severity0'>Enabled</span>";
            $btn1_class = "disabled";
        }
...
<article>
    <div style="margin-left: 40px; padding-left: 10px; border-left: 1px solid #58606b">
        ...
        <span class='badge badge1 severity2'><?php print _("Disabled"); ?></span> <?php print _("2fa is disabled"); ?>
        <br>
        <span class='badge badge1 severity1'><?php print _("Enabled, not activated"); ?></span> <?php print _("2fa is enabled, but secret is not set. User will be given new secret upon first login"); ?>
        .<br>
    </div>
</article>
...
<article style='margin-top:50px;' class="text-muted">
    ...
    <br>
    After user successfully logs in it will be presented with additional screen to enter code from Google authenticator
    application.
    <br><br>
    Google Authenticator is available on following links based on your OS:
    <ul>
        <li><a href='https://itunes.apple.com/us/app/google-authenticator/id388497605?mt=8' target="_self">Apple iOS</a>
        </li>
        <li><a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2"
               target="_self">Android</a></li>
    </ul>
