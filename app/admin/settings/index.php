...
<form name="settings" id="settings">
    <table id="settings" class="table table-hover table-condensed table-top">
        ...
        <tr>
            <td>
            <?php print _('Site title'); ?></th>
            <td>
                <input type="text" class="form-control input-sm" name="siteTitle"
                       value="<?php print $settings['siteTitle']; ?>">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="siteDomain"
                       value="<?php print $settings['siteDomain']; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="siteURL"
                       value="<?php print $settings['siteURL']; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="siteLoginText"
                       value="<?php print $settings['siteLoginText']; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="prettyLinks" class="form-control input-sm input-w-auto">
                    ...
                    if ($settings['prettyLinks'] == "Yes") {
                        print "<option value='Yes' selected='selected'>" . _('Yes') . "</option>";
                    } else {
                        print "<option value='Yes'>" . _('Yes') . "</option>";
                    }
                    ?>
                </select>
            </td>
            <td class="info2">
                ...
                <?php print _("Please note that mod_rewrite is required with appropriate settings if pretified links are selected."); ?>
                <br>
                ...
                <select name="defaultLang" class="form-control input-sm input-w-auto">
                    ...
                    if (sizeof($languages) > 0) {
                        ...
                        foreach ($languages as $lang) {
                            if ($lang->l_id == $settings['defaultLang']) {
                                print "<option value='$lang->l_id' selected='selected'>$lang->l_name ($lang->l_code)</option>";
                            } else {
                                print "<option value='$lang->l_id' 					>$lang->l_name ($lang->l_code)</option>";
                            }
                        }
                    }
                    ?>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="permissionPropagate" <?php if ($settings['permissionPropagate'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <select name="inactivityTimeout" class="form-control input-sm input-w-auto">
                    <?php
                    $durations = ["900" => "15 minutes", "1800" => "30 minutes", "3600" => "1 hour", "7200" => "2 hours", "21600" => "6 hours", "43200" => "12 hours", "86400" => "24 hours"];
                    //default
                    foreach ($durations as $k => $d) {
                        if ($k == $settings['inactivityTimeout']) {
                            print "<option value='$k' selected='selected'>$d</option>";
                        } else {
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="vlanMax"
                       value="<?php print $settings['vlanMax']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="maintaneanceMode" <?php if ($settings['maintaneanceMode'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="siteAdminName"
                       value="<?php print $settings['siteAdminName']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="siteAdminMail"
                       value="<?php print $settings['siteAdminMail']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="api" <?php if ($settings['api'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableIPrequests" <?php if ($settings['enableIPrequests'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableVRF" <?php if ($settings['enableVRF'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableNAT" <?php if ($settings['enableNAT'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enablePowerDNS" <?php if ($settings['enablePowerDNS'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
...
-->
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableFirewallZones" <?php if ($settings['enableFirewallZones'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="enableDNSresolving" <?php if ($settings['enableDNSresolving'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="tempShare" <?php if ($settings['tempShare'] == 0) print ''; else print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="enableChangelog" <?php if ($settings['enableChangelog'] == 0) print ''; else print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableMulticast" <?php if ($settings['enableMulticast'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableThreshold" <?php if ($settings['enableThreshold'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableRACK" <?php if ($settings['enableRACK'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableCircuits" <?php if ($settings['enableCircuits'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableLocations" <?php if ($settings['enableLocations'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableSNMP" <?php if ($settings['enableSNMP'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enablePSTN" <?php if ($settings['enablePSTN'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableCustomers" <?php if ($settings['enableCustomers'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enableRouting" <?php if ($settings['enableRouting'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
            ...
            <td>
                <select name="link_field" class="form-control input-sm input-w-auto">
                    ...
                    foreach ($custom_fields as $k => $d) {
                        if ($d['name'] == $settings['link_field']) {
                            print "<option value='$d[name]' selected='selected'>$d[name]</option>";
                        } else {
                            print "<option value='$d[name]' 				     >$d[name]</option>";
                        }
                    }
                    ?>
                </select>
        ...
        <tr>
            ...
            <td>
                <select name="log" class="form-control input-sm input-w-auto">
                    <?php
                    $types = ["Database" => "Database", "syslog" => "Syslog", "both" => "Syslog and local Database"];
                    //default
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="updateTags" <?php if ($settings['updateTags'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="enforceUnique" <?php if ($settings['enforceUnique'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="vlanDuplicate" <?php if ($settings['vlanDuplicate'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" value="1"
                       name="decodeMAC" <?php if ($settings['decodeMAC'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <select name="scanPingType" class="form-control input-sm input-w-auto">
                    <?php
                    $types = ["ping" => "ping", "pear" => "pear ping", "fping" => "fping"];
                    //default
                    foreach ($types as $k => $d) {
                        if ($k == $settings['scanPingType']) {
                            print "<option value='$k' selected='selected'>$d</option>";
                        } else {
                            print "<option value='$k' 				   >$d</option>";
                        }
        ...
        <tr>
            ...
            if (!file_exists($settings['scanPingPath']) && $settings['scanFPingType'] == "ping") {
                $class = "danger";
            } else {
                $class = "";
            }
            ...
            <td class="<?php print $class; ?>">
                <input type="text" class="form-control input-sm" name="scanPingPath"
                       value="<?php print $settings['scanPingPath']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <?php
            //verify that ping file exists!
            if (!file_exists($settings['scanFPingPath']) && $settings['scanFPingType'] == "fping") {
                $class = "danger";
            } else {
                $class = "";
            }
            ?>
            <td class="<?php print $class; ?>">
                <input type="text" class="form-control input-sm" name="scanFPingPath"
                       value="<?php print $settings['scanFPingPath']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="pingStatus"
                       value="<?php print $settings['pingStatus']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="scanMaxThreads"
                       value="<?php print $settings['scanMaxThreads']; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="donate" <?php if ($settings['donate'] == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <select name="subnetOrdering" class="form-control input-sm input-w-auto">
                    ...
                    foreach ($opts as $key => $line) {
                        if ($settings['subnetOrdering'] == $key) {
                            print "<option value='$key' selected>$line</option>";
                        } else {
                            print "<option value='$key'>$line</option>";
                        }
        ...
        <tr>
            ...
            <td>
                <a class='btn btn-sm btn-default open_popup' data-script='app/admin/settings/logo/logo-uploader.php'
                   data-class='700' data-csrf_cookie='<?php print $csrf; ?>'><i
                            class="fa fa-upload"></i> <?php print _("Upload"); ?></a>
            </td>
            <td class="info2">
        ...
        <tr class="th">
            <td class="title"></td>
            <td class="submit">
                <input type="submit" class="btn btn-default btn-success btn-sm submit_popup"
                       data-script="app/admin/settings/settings-save.php" data-result_div="settingsEdit"
                       data-form='settings' value="<?php print _("Save"); ?>">
            </td>
            <td></td>
        </tr>
