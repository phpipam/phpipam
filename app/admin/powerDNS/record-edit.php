...
<!-- header -->
<div class="pHeader"><?php print ucwords(_("$_POST[action]")); ?> <?php print _('DNS record'); ?> <?php print _('for domain'); ?>
    <strong><?php print $domain->name; ?></strong></div>
    ...
    <form id="recordEdit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm" name="name"
                           placeholder="<?php print _('www.example.com'); ?>"
                           value="<?php print $record->name; ?>" <?php print $readonly; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm" name="content"
                           placeholder="<?php print _('10.10.10.1'); ?>"
                           value="<?php print $record->content; ?>" <?php print $readonly; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm input-w-100" name="prio"
                           placeholder="<?php print _('Priority'); ?>"
                           value="<?php print $record->prio; ?>" <?php print $readonly; ?>>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <?php if ($_POST['action'] !== "delete" && isset($record->id) && $User->get_module_permissions("pdns") > 2) { ?>
            <button class="btn btn-sm btn-default btn-danger" id="editRecordSubmitDelete"><i
                        class="fa fa-trash-o"></i> <?php print _("Delete"); ?></button>
        <?php } ?>
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            print "btn-danger";
        } else {
            print "btn-success";
        } ?>" id="editRecordSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
