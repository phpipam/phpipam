    ...
    <form id="domainEdit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm" name="name"
                           placeholder="<?php print _('FQDN domain name'); ?>"
                           value="<?php print $domain->name; ?>" <?php print $readonly; ?> <?php if ($_POST['action'] != "add") {
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm" name="master"
                           placeholder="<?php print _('NULL'); ?>"
                           value="<?php print $domain->master; ?>" <?php print $readonly; ?>>
                </td>
            </tr>
            ...
            if ($_POST['action'] == "add") {
                ...
                <tr>
                    <td colspan="2">
                        <hr>
                        <strong><?php print _("Default record values (SOA, NS)"); ?></strong><br><br></td>
                </tr>
                ...
                <tr>
                    <td>
                    <?php print _('Hostmaster'); ?></th>
                    <td>
                        <input type="text" class="form-control input-sm" name="hostmaster"
                               value="<?php print $pdns->hostmaster; ?>">
                    </td>
                </tr>
                <!-- ttl -->
                <tr>
                ...
                <tr>
                    <td>
                    <?php print _('NXDOMAIN ttl'); ?></th>
                    <td>
                        <select name="nxdomain_ttl"
                                class="form-control input-w-auto input-sm" <?php print $readonly; ?>>
                            <?php
                            // loop
                            foreach ($PowerDNS->ttl as $k => $ttl) {
                                // max 10800
                ...
                <tr>
                    <td></td>
                    <td>
                        <input type="checkbox" class="hideDefaults" value="1"
                               name="manual"> <?php print _("Dont create default records (SOA, NS)"); ?>
                    </td>
                </tr>
            <?php } ?>
...
<div class="pFooter">
    <div class="btn-group">
        <button class="btn btn-sm btn-default <?php if (@$_POST['secondary'] == "true") {
            print "hidePopup2";
        } else {
            print "hidePopups";
        } ?>"><?php print _('Cancel'); ?></button>
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            print "btn-danger";
        } else {
            print "btn-success";
        } ?> <?php if (@$_POST['secondary'] == "true") {
            print "editDomainSubmit2";
        } ?>" id="editDomainSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
