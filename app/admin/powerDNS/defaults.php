...
<form name="pdns" id="pdns-defaults">
    <table id="settings" class="table table-hover table-condensed table-auto">
        ...
        <tr>
            <td>
            <?php print _('Default PTR domain'); ?></th>
            <td>
                <input type="text" class="form-control input-sm" name="def_ptr_domain" placeholder="Not used"
                       value="<?php print $pdns->def_ptr_domain; ?>">
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="text-align: right">
                <input type="submit" class="btn btn-default btn-sm submit_popup"
                       data-script="app/admin/powerDNS/defaults-save.php" data-result_div="settingsEdit"
                       data-form='pdns-defaults' value="<?php print _("Save"); ?>">
            </td>
        </tr>
