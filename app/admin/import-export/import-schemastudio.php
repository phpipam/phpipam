...
include 'import-schemastudio-check.php';

?>

<!-- header -->
<div class="pHeader"><?php print _("Schema Studio Subnet import"); ?></div>
...
foreach ($data as &$cdata) {
	if (($cdata['action'] == "add") || ($cdata['action'] == "edit")) {
		...
		# update
		$cdata['result'] = $Admin->object_modify("schemastudios", $cdata['action'], "id", $values);
