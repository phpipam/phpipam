...
<!-- header -->
<div class="pHeader"><?php print _("Schema Management IP import data preview"); ?></div>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default" id="dataImportSubmit" data-type="schemaip" disabled><i class="fa fa-upload"></i> <?php print _('Import'); ?></button>
	</div>
</div>
