...
/**
 *	Preview data customers import data
 ************************************/
...
<!-- header -->
<div class="pHeader"><?php print _("Customers import data preview"); ?></div>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default" id="dataImportSubmit" data-type="customers" disabled><i class="fa fa-download"></i> <?php print _('Import'); ?></button>
	</div>
</div>
