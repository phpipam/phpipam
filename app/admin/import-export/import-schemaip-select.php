...
$expfields = array ("locationSize", "deviceType", "deviceNumber", "offset");
$mtable = "schemamgmtips"; # main table where to check the fields
...
$reqfields = array("locationSize", "deviceType", "deviceNumber", "offset");
...
<!-- header -->
<div class="pHeader"><?php print _("Select Management IP file and fields to import"); ?></div>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default" id="dataImportPreview" data-type="schemaip" disabled><i class="fa fa-eye"></i> <?php print _('Preview'); ?></button>
	</div>
</div>
