...
$section_ids = array();
$fields = array ( "locationSize", "addressType", "vrf", "description", "isSummary", "parent", "mask", "offset", "base", "vlanDef" );

$schemas = $Tools->fetch_all_objects("schemasubnets", "id");


# Create a workbook
$today = date("Ymd");
$filename = $today."_phpipam_schema_export.xls";
			...
			switch ($k){
				...
				case "parent":
					if ($d[$k]==0){$d[$k]="None";}
						...
						$parent = $Tools->fetch_object("schemasubnets", "id",$d[$k]);
