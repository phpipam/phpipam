...
print "	<td><input type='checkbox' name='contact_person'> </td>";
print "	<td><input type='checkbox' name='contact_phone'> </td>";
print "	<td><input type='checkbox' name='contact_mail'> </td>";
