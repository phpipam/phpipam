...
$expfields = array ("studioType", "addressType", "vrf", "description", "isSummary", "parent", "mask", "offset", "base", "vlanDef");
$mtable = "schemasubnets"; # main table where to check the fields

// # extra fields
$extfields["studioType"]["table"] = "studiotypes";
$extfields["studioType"]["field"] = "studioType";
$extfields["studioType"]["pname"] = "studioType";
...
$reqfields = array("studioType", "addressType", "description", "isSummary", "parent", "mask", "offset", "base");
...
<!-- header -->
<div class="pHeader"><?php print _("Select Schema file and fields to import"); ?></div>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default" id="dataImportPreview" data-type="schemastudio" disabled><i class="fa fa-eye"></i> <?php print _('Preview'); ?></button>
	</div>
</div>
