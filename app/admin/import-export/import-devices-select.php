...
$expfields = ["hostname", "ip_addr", "deviceType", "description", "section", "rack", "rack_start", "rack_size", "location"];
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default" id="dataImportPreview" data-type="devices" disabled><i
                    class="fa fa-eye"></i> <?php print _('Preview'); ?></button>
    </div>
</div>
