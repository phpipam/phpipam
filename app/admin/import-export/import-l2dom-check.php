...
foreach ($data as &$cdata) {
    ...
    if (isset($unique[$cdata['name']])) {
        $msg .= "Duplicate VLAN domain found. Please check import file.";
        $action = "error";
    }
    ...
    if ($action != "error") {
        if (isset($edata[$cdata['name']])) {
            ...
            if ($cdata['description'] != $edata[$cdata['name']]['description']) {
                $msg .= "L2 Domain description will be updated.";
                $action = "edit";
            }
