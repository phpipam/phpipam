        ...
        <tr>
            <td align="left">
                <div id="drop">
                    ...
                    <input type="hidden" name="expfields" value="<?php print implode('|', $expfields); ?>"
                           style="display:none;">
                    
                    <?php print _('Select file'); ?>: <a class="btn btn-sm btn-default"><i
                                class="fa fa-folder-open"></i> <?php print _("Browse / Drag & Drop"); ?></a>
                </div>
            </td>
            <td>&nbsp;</td>
            <td align="right">
