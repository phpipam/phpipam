    ...
    <form id="widgetEdit" name="widgetEdit">
        <table class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td><input class="form-control input-sm input-w-250" type="text" name="wtitle"
                           value="<?php print $Admin->strip_xss(@$w['wtitle']); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="form-control input-sm input-w-250" type="text" name="wdescription"
                           value="<?php print $Admin->strip_xss(@$w['wdescription']); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
            ...
            <tr>
                ...
                <td><input class="form-control input-sm input-w-250" type="text" name="wfile"
                           value="<?php print $Admin->strip_xss(@$w['wfile']); ?>.php" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input class="form-control input-sm input-w-250" type="text" name="wparams"
                           value="<?php print $Admin->strip_xss(@$w['wparams']); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>' data-script="app/admin/widgets/edit-result.php" data-result_div="widgetEditResult" data-form='widgetEdit'>
