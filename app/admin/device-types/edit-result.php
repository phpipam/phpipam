...
if ($_POST['tname'] == "") {
    $Result->show("danger", _('Name is mandatory') . '!', false);
}

# create array of values for modification
$values = ["tid" => @$_POST['tid'],
    "tname" => $_POST['tname'],
    "tdescription" => @$_POST['tdescription']];

# update
if (!$Admin->object_modify("deviceTypes", $_POST['action'], "tid", $values)) {
    $Result->show("danger", _("Failed to $_POST[action] device type") . '!', false);
} else {
    $Result->show("success", _("Device type $_POST[action] successfull") . '!', false);
}
