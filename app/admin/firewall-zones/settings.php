    ...
    <table id="settings" class="table table-hover table-condensed table-auto">
        ...
        <tr>
            ...
            <td style="width:120px;">
                <input type="text" class="form-control input-sm" name="zoneLength"
                       value="<?php print $firewallZoneSettings['zoneLength']; ?>">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" name="padding"
                       value="on" <?php if ($firewallZoneSettings['padding'] == 'on') {
                    print 'value="' . $firewallZoneSettings['padding'] . '" checked';
                } ?>>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" name="strictMode"
                       value="on" <?php if ($firewallZoneSettings['strictMode'] == 'on') {
                    print 'value="' . $firewallZoneSettings['strictMode'] . '" checked';
                } ?>>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" class="input-switch" name="autogen"
                       value="on" <?php if ($firewallZoneSettings['autogen'] == 'on') {
                    print 'value="' . $firewallZoneSettings['autogen'] . '" checked';
                } ?>>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="ipType[0]"
                       value="<?php print $firewallZoneSettings['ipType']['0']; ?>">
            </td>
            <td rowspan="2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="ipType[1]"
                       value="<?php print $firewallZoneSettings['ipType']['1']; ?>">
            </td>
        </tr>
        <!-- separator -->
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="separator"
                       value="<?php print $firewallZoneSettings['separator']; ?>">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="indicator[0]"
                       value="<?php print $firewallZoneSettings['indicator']['0']; ?>">
            </td>
            <td rowspan="2">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="indicator[1]"
                       value="<?php print $firewallZoneSettings['indicator']['1']; ?>">
            </td>
        </tr>
