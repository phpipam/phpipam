                    ...
                    <div class="radio" style="margin-top:5px;margin-bottom:2px;">
                        <label>
                            <input type="radio" name="indicator"
                                   value="0" <?php (($firewallZone->indicator == false) ? print 'checked' : print ''); ?> ><?php print '<span class="fa fa-home"  title="' . _('Own zone') . '"></span> ' . _('Own Zone'); ?>
                        </label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="radio" style="margin-top:2px;margin-bottom:2px;">
                        <label>
                            <input type="radio" name="indicator"
                                   value="1" <?php (($firewallZone->indicator == true) ? print 'checked' : print ''); ?> ><?php print '<span class="fa fa-group"  title="' . _('Customer zone') . '"></span> ' . _('Customer Zone'); ?>
                        </label>
                    </div>
                </td>
            </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" class="input-switch"
                               name="padding" <?php if ($_POST['action'] == 'edit' && $firewallZone->padding == 1) {
                            print 'checked';
                        } elseif ($_POST['action'] == 'edit' && $firewallZone->padding == 0) {
                        } elseif ($firewallZoneSettings['padding'] == 'on') {
                            print 'checked';
                        } ?>>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="description"
                           placeholder="<?php print _('Zone description'); ?>"
                           value="<?php print $firewallZone->description; ?>">
                </td>
            </tr>
        </table>

        <!-- network information -->
        <span class="btn btn-sm btn-default btn-success editNetwork" style="margin-bottom:10px;margin-top: 25px;"
              data-action="add" data-zoneId="<?php print $firewallZone->id; ?>"><i style="padding-right:5px;"
                                                                                   class="fa fa-plus"></i><?php print _('Add a network to the Zone'); ?></span>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editZoneSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
