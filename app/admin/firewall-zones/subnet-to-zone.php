...
if ($_POST['operation'] != 'subnet2zone') {
    $Result->show("danger", _("Invalid operation. Do not manipulate the POST values!"), true);
}
...
if (!is_array($firewallZones)) {
    $Result->show("danger", _("No zones available"), true, true);
}
?>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default btn-success" id="subnet-to-zone-submit"><i
                    class="fa fa-plus"></i> <?php print _('Add this subnet to a firewall zone'); ?></button>
    </div>
    <!-- result -->
