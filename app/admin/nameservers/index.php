...
<button class='btn btn-sm btn-default open_popup' data-script='app/admin/nameservers/edit.php' data-class='700'
        data-action='add' style='margin-bottom:10px;'><i class='fa fa-plus'></i> <?php print _('Add nameserver set'); ?>
</button>
...
if ($all_nameservers === false) {
    $Result->show("danger", _("No nameserver sets defined") . "!", true);
} else {
