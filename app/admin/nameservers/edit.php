...
# set nameservers
$nameservers['namesrv1'] = !isset($nameservers) ? [" "] : explode(";", $nameservers['namesrv1']);
?>
...
<div class="pContent">
    ...
    <form id="nameserverManagementEdit">
        <table id="nameserverManagementEdit2" class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="name form-control input-sm" name="name"
                           placeholder="<?php print _('Nameserver set'); ?>"
                           value="<?php print @$nameservers['name']; ?>" <?php print $readonly; ?>>
                </td>
                <td></td>
            </tr>
            </tbody>
            ...
            <tr>
                <td></td>
                <td>
                    <button class="btn btn-sm btn-default" id="add_nameserver"
                            data-id='<?php print $m; ?>' <?php print $readonly; ?>><i
                                class="fa fa-plus"></i> <?php print _('Add nameserver'); ?></button>
                </td>
                <td></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    if (($_POST['action'] == "edit") || ($_POST['action'] == "delete")) {
                        print '<input type="hidden" name="nameserverid" value="' . $_POST['nameserverid'] . '">' . "\n";
                    }
                    ?>
                    <input type="hidden" name="action" value="<?php print $_POST['action']; ?>">
                    <input type="hidden" name="csrf_cookie" value="<?php print $csrf; ?>">
                    <input type="text" class="description form-control input-sm" name="description"
                           placeholder="<?php print _('Description'); ?>"
                           value="<?php print $Tools->strip_xss(@$nameservers['description']); ?>" <?php print $readonly; ?>>
                </td>
                <td></td>
            </tr>
            ...
            <!-- sections -->
            <tr>
                <td style="vertical-align: top !important"><?php print _('Sections to display nameserver set in'); ?>:
                </td>
                <td>
                    <?php
                    # select sections
    ...
    if ($_POST['action'] == "delete") {
        $Result->show("warning", "<strong>" . _('Warning') . ":</strong> " . _("removing nameserver set will also remove all references from belonging subnets!"), false);
    }
    ?>
</div>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>' data-script="app/admin/nameservers/edit-result.php" data-result_div="nameserverManagementEditResult"
                data-form='nameserverManagementEdit'>
