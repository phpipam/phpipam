...
# update
if (!$Admin->object_modify("nameservers", $_POST['action'], "id", $values)) {
...
if ($_POST['action'] == "delete") {
    $Admin->remove_object_references("subnets", "nameserverid", $_POST['nameserverid']);
}