    ...
    <form id="usersEdit" name="usersEdit">
        <table class="usersEdit table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td><input type="text" class="form-control input-sm" name="real_name"
                           value="<?php print @$user['real_name']; ?>"></td>
            ...
            <tr>
                ...
                <td><input type="text" class="form-control input-sm" name="username"
                           value="<?php print @$user['username']; ?>" <?php if ($_POST['action'] == "edit" || $_POST['action'] == "delete") print 'readonly'; ?>>
                </td>
                <td class="info2">
                    <a class='btn btn-xs btn-default adsearchuser' rel='tooltip' title='Search AD for user details'><i
            ...
            <tr>
                ...
                <td><input type="text" class="form-control input-sm input-w-250" name="email"
                           value="<?php print @$user['email']; ?>"></td>
                ...
                <td>
                    <select name="authMethod" id="authMethod" class="form-control input-sm input-w-auto">
                        ...
                        foreach ($auth_types as $type) {
                            # match
                            if ($type->id == @$user['authMethod']) {
                                print "<option value='$type->id' selected>$type->type ($type->description)</option>";
                            } else {
                                print "<option value='$type->id'         >$type->type ($type->description)</option>";
                            }
                        }
                        ?>
                    </select>
            ...
            <tr class="password">
                ...
                <td class="info2"><?php print _("User's password"); ?> (<a href="#"
                                                                           id="randomPass"><?php print _('click to generate random'); ?>
                        !</a>)
                </td>
            </tr>
                ...
                <td>
                    <select name="lang" class="form-control input-sm input-w-auto">
                        ...
                        foreach ($langs as $lang) {
                            if ($lang->l_id == $user['lang']) {
                                print "<option value='$lang->l_id' selected>$lang->l_name ($lang->l_code)</option>";
                            } else {
            ...
            <tr>
                ...
                <td><input type="checkbox" name="notifyUser" value="on" <?php if ($_POST['action'] == "add") {
                        print 'checked';
            ...
            <tr>
                <td colspan="3">
                    <hr>
                    <h5><strong><?php print _('Groups'); ?>:</strong></h5></td>
            </tr>
            <tr>
                ...
                <td class="groups">
                    ...
                    if ($groups !== false) {
                        ...
                        foreach ($groups as $g) {
                            # empty fix
                            if (sizeof($ugroups) > 0) {
                                if (in_array($g->g_id, $ugroups)) {
                                    print "<input type='checkbox' name='group$g->g_id' checked>$g->g_name<br>";
                                } else {
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>' data-script="app/admin/users/edit-result.php" data-result_div="usersEditResult" data-form='usersEdit'>
