...
<div class="pContent">
    ...
    <table class="table table-noborder">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control input-sm" id='dusername' name="dusername"
                       placeholder="<?php print _('Username'); ?>"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <button class='btn btn-sm btn-default pull-right' class="form-control input-sm"
                        id="adsearchusersubmit"><?php print _('Search'); ?></button>
            </td>
        </tr>
