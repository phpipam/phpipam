    ...
    <form id="agentEdit" name="agentEdit">
        <table class="groupEdit table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$agent->name); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
            ...
            <tr>
                ...
                <td><input type="text" id="description" name="description" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$agent->description); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
            ...
            <?php if (@$agent->type !== "direct") { ?>
                ...
                <tr>
                    ...
                    <td><input type="text" id="code" name="code" class="form-control input-sm"
                               value="<?php print $Admin->strip_xss(@$agent->code); ?>"
                               maxlength='32' <?php if (@$agent->type == "direct" || $_POST['action'] == "delete") print "readonly"; ?>>
                    </td>
                    <td class="info2"><?php print _('Agent code'); ?><?php if (@$agent->type != "direct") { ?>
                            <button class="btn btn-xs btn-default" id="regAgentKey"><i
                                    class="fa fa-random"></i> <?php print _('Regenerate'); ?></button><?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <select name="type"
                                class="form-control input-sm input-w-auto" <?php if (@$agent->type == "direct" || $_POST['action'] == "delete") print "readonly"; ?>>
                            <?php
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?> submit_popup' data-script="app/admin/scan-agents/edit-result.php" data-result_div="agentEditResult"
                data-form='agentEdit'>
