...
<div class="alert alert-info alert-absolute"><?php print _('You can select which fields are actually being used for IP management, so you dont show any overhead if not used. IP, hostname and description are mandatory'); ?>
    .
</div>
    ...
    <form id="filterIP" style="margin-top:50px;clear:both;">
        <table class="filterIP table table-auto table-top" style='width:auto'>
            ...
            <tr>
                <td></td>
                <td>
                    <a class='btn btn-xs btn-success submit_popup'
                       data-script="app/admin/filter-fields/filter-result.php" data-result_div="filterIPResult"
                       data-form='filterIP'>
