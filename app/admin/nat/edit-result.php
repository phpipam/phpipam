...
if ($_POST['action'] == "add" || $_POST['action'] == "edit") {
    ...
    if (!in_array($_POST['type'], ["source", "static", "destination"])) {
        $Result->show("danger", _("Invalid NAT type"), true);
    }
...
if (!$Admin->object_modify("nat", $_POST['action'], "id", $values)) {
    $Result->show("danger", _("NAT $_POST[action] failed"), false);
} else {
    $Result->show("success", _("NAT $_POST[action] successful"), false);
}
