        ...
        <table id="editNat" class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="name"
                           value="<?php print $Tools->strip_xss($nat->name); ?>"
            ...
            <tr>
                ...
                <td colspan="2">
                    <textarea class="form-control input-sm" name="description"
                              placeholder='<?php print _('Port'); ?>' <?php print $readonly; ?>><?php print $nat->description; ?></textarea>
                </td>
            </tr>
            ...
            <?php if ($_POST['action'] !== "add") { ?>
                ...
                <tr class='port'>
                    ...
                    <td>
                        <input type="text" class="form-control input-sm" name="policy_dst"
                               value="<?php print $nat->policy_dst; ?>"
                               placeholder='<?php print _('IP'); ?>' <?php print $readonly; ?>>
                    </td>
                    <td>
                ...
                <tr class='port'>
                    ...
                    <td>
                        <input type="text" class="form-control input-sm" name="src_port"
                               value="<?php print $nat->src_port; ?>"
                               placeholder='<?php print _('Port'); ?>' <?php print $readonly; ?>>
                    </td>
                    <td>
                ...
                <tr class='port'>
                    ...
                    <td>
                        <input type="text" class="form-control input-sm" name="dst_port"
                               value="<?php print $nat->dst_port; ?>"
                               placeholder='<?php print _('Port'); ?>' <?php print $readonly; ?>>
                    </td>
                    <td>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editNatSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
