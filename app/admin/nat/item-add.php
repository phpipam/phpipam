...
# validate type
if (!in_array($_POST['type'], ["src", "dst"])) {
    $Result->show("danger", _("Invalid NAT direction"), true, true);
}
...
<div class="pContent">
    ...
    <form id="search_nats" style="margin-bottom: 10px;" class="form-inline">
        ...
        <input type="text" class='form-control input-sm' name="ip" placeholder="<?php print _('Enter subnet/IP'); ?>"
