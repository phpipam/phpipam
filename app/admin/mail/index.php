...
<form name="mailsettings" id="mailsettings">
    <table id="mailsettingstbl" class="table table-hover table-condensed table-top table-auto">
        ...
        <tr>
            <td>
            <?php print _('Server address'); ?></th>
            <td>
                <input type="text" name="mserver" class='smtp form-control input-sm'
                       value="<?php print $mail_settings->mserver; ?>">
            </td>
        ...
        <tr>
            ...
            <?php print _('Port'); ?></th>
            <td>
                <input type="text" name="mport" class='smtp form-control input-sm'
                       value="<?php print $mail_settings->mport; ?>">
            </td>
        ...
        <tr>
            <td>
            <?php print _('Server authentication'); ?></th>
            <td>
        ...
        <tr>
            <td>
            <?php print _('Username'); ?></th>
            <td>
                <input type="text" name="muser" class='smtp form-control input-sm'
                       value="<?php print $mail_settings->muser; ?>">
            </td>
        ...
        <tr>
            <td>
            <?php print _('Password'); ?></th>
            <td>
                <input type="password" name="mpass" class='smtp form-control input-sm'
                       value="<?php print $mail_settings->mpass; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="50" class="form-control input-sm" name="mAdminName"
                       value="<?php print $mail_settings->mAdminName; ?>">
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="text" size="50" class="form-control input-sm" name="mAdminMail"
                       value="<?php print $mail_settings->mAdminMail; ?>">
            </td>
            <td class="info2">
        ...
        <tr class="th">
            ...
            <td class="submit" style="padding-top:30px;">
                <div class="btn-group pull-right">
                    <a class='btn btn-sm btn-default submit_popup' data-script="app/admin/mail/test-mail.php"
                       data-result_div="settingsMailEdit" data-form='mailsettings' data-noreload='true'><i
                                class="icon icon-gray icon-envelope"></i> <?php print _('Send test email'); ?></a>
                    <input type="submit" class="btn btn-default btn-success btn-sm submit_popup"
                           data-script="app/admin/mail/edit.php" data-result_div="settingsMailEdit"
                           data-form='mailsettings' value="<?php print _("Save"); ?>">
                </div>
            </td>
            <td></td>
        </tr>
