...
<table id="mailsettingstbl" class="table table-hover table-condensed table-top table-auto">
	...
	<tr>
		...
		<td>
			<input type="text" name="muser" maxlength="64" class='smtp form-control input-sm' value="<?php print $mail_settings->muser; ?>">
		</td>
	...
	<tr>
		...
		<td>
			<input type="password" name="mpass" maxlength="96" class='smtp form-control input-sm' value="<?php print $mail_settings->mpass; ?>">
		</td>
