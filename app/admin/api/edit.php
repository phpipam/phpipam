...
<div class="pContent">
	...
	<tr>
	    ...
	    <td>
	    	<input type="text" name="app_id" class="form-control input-sm" value="<?php print escape_input($api->app_id); ?>" <?php if($POST->action == "delete") print "readonly"; ?>>
	...
	<tr>
	    ...
	    <td><input type="text" id="appcode" name="app_code" class="form-control input-sm"  value="<?php print escape_input($api->app_code); ?>"  maxlength='32' <?php if($POST->action == "delete") print "readonly"; ?>></td>
    ...
    <tr>
    	...
    	<td>
    		<input type="text" name="app_comment" class="form-control input-sm" value="<?php print escape_input($api->app_comment); ?>" <?php if($POST->action == "delete") print "readonly"; ?>>
    	</td>
