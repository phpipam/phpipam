    ...
    <form id="apiEdit" name="apiEdit">
        <table class="groupEdit table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="app_id" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$api->app_id); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
            ...
            <tr>
                ...
                <td><input type="text" id="appcode" name="app_code" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$api->app_code); ?>"
                           maxlength='32' <?php if ($_POST['action'] == "delete") print "readonly"; ?>></td>
                <td class="info2"><?php print _('Application code'); ?>
                    <button class="btn btn-xs btn-default" id="regApiKey"><i
                                class="fa fa-random"></i> <?php print _('Regenerate'); ?></button>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select name="app_permissions" class="form-control input-sm input-w-auto">
                        <?php
                        $perms = [0 => "Disabled", 1 => "Read", 2 => "Read / Write", 3 => "Read / Write / Admin"];
                        foreach ($perms as $k => $p) {
                            if ($k == $api->app_permissions) {
                                print "<option value='$k' selected='selected'>" . _($p) . "</option>";
                            } else {
                                print "<option value='$k' 				   >" . _($p) . "</option>";
                            }
                        }
                        ?>
                    </select>
            ...
            <tr>
                ...
                <td>
                    <select name="app_security" class="form-control input-sm input-w-auto">
                        <?php
                        $perms = ["SSL with User token" => "ssl_token", "SSL with App code token" => "ssl_code", "Encrypted" => "crypt", "User token" => "none"];
                        
                        foreach ($perms as $k => $p) {
                            if ($p == $api->app_security) {
                                print "<option value='$p' selected='selected'>" . _($k) . "</option>";
                            } else {
                                print "<option value='$p' 				   >" . _($k) . "</option>";
                            }
                        }
                        ?>
                    </select>
            ...
            <tr>
                ...
                <td>
                    <input name="app_lock_wait" class="form-control input-sm input-w-auto"
                           value="<?php print $Admin->strip_xss($api->app_lock_wait); ?>">
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="app_nest_custom_fields" class="form-control input-sm input-w-auto">
                        ...
                        $perms = [0 => "No", 1 => "Yes"];
                        foreach ($perms as $k => $p) {
                            if ($k == $api->app_nest_custom_fields) {
                                print "<option value='$k' selected='selected'>" . _($p) . "</option>";
                            } else {
                                print "<option value='$k' 				   >" . _($p) . "</option>";
                            }
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="app_comment" class="form-control input-sm"
                           value="<?php print $Admin->strip_xss(@$api->app_comment); ?>" <?php if ($_POST['action'] == "delete") print "readonly"; ?>>
                </td>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class='btn btn-sm btn-default submit_popup <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>' data-script="app/admin/api/edit-result.php" data-result_div="apiEditResult" data-form='apiEdit'>
