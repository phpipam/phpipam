...
<hr>
<div class="btn-group">
    <a href="<?php print create_link("administration", "devices"); ?>" class="btn btn-xs btn-default"
       style='margin-bottom:10px;'><i class='fa fa-plus'></i> <?php print _('Manage devices'); ?></a>
</div>
