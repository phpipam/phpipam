    ...
    if (@$errmsg_class != "danger") {
        ...
        <form class="manageRequestEdit" name="manageRequestEdit">
            ...
            <table id="manageRequestEdit" class="table table-noborder table-condensed">
                ...
                <!-- divider -->
                <tr>
                    <td colspan="2"><h4>Request details</h4>
                        <hr>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ip_addr" class="ip_addr form-control input-sm"
                               value="<?php print $Tools->strip_xss($ip_address); ?>" size="30">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="description" class="form-control input-sm"
                               value="<?php print $Tools->strip_xss(@$request['description']); ?>" size="30"
                               placeholder="<?php print _('Enter IP description'); ?>">
                    </td>
                </tr>
                <!-- DNS name -->
                <tr>
                    ...
                    <td>
                        <input type="text" name="hostname" class="form-control input-sm"
                               value="<?php print $Tools->strip_xss(@$request['hostname']); ?>" size="30"
                               placeholder="<?php print _('Enter hostname'); ?>">
                    </td>
                </tr>
                ...
                <?php if (in_array('owner', $selected_ip_fields)) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="owner" class="form-control input-sm" id="owner"
                                   value="<?php print $Tools->strip_xss(@$request['owner']); ?>" size="30"
                                   placeholder="<?php print _('Enter IP owner'); ?>">
                        </td>
                    </tr>
                <?php } ?>
                ...
                <?php if (in_array('switch', $selected_ip_fields)) { ?>
                    ...
                    <?php if (in_array('port', $selected_ip_fields)) { ?>
                        /
                        <input type="text" name="port" class="form-control input-sm input-w-100"
                               value="<?php print $Tools->strip_xss(@$request['port']); ?>"
                               placeholder="<?php print _('Port'); ?>">
                        </td>
                        </tr>
                    <?php } ?>
                    </td>
                ...
                <?php if (in_array('note', $selected_ip_fields)) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="note" class="form-control input-sm" id="note"
                                   placeholder="<?php print _('Write note'); ?>" size="30">
                        </td>
                    </tr>
                <?php } ?>
                ...
                <!-- divider -->
                <tr>
                    <td colspan="2" style="padding-top:30px;"><h4>Additional information</h4>
                        <hr>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" disabled="disabled" class="form-control"
                               value="<?php print $Tools->strip_xss(@$request['requester']); ?>">
                    </td>
                </tr>
                <!-- comment -->
                <tr>
                    ...
                    <td>
                        <input type="text" disabled="disabled" class="form-control"
                               value="<?php print $Tools->strip_xss(@$request['comment']); ?>">
                        <?php print "<input type='hidden' name='comment' value='" . $Tools->strip_xss(@$request['comment']) . "'>"; ?></i>
                    </td>
                </tr>
                <!-- Admin comment -->
                <tr>
                    ...
                    <td>
                        <textarea name="adminComment" rows="3" cols="30" class="form-control input-sm"
                                  placeholder="<?php print _('Enter reason for reject/approval to be sent to requester'); ?>"></textarea>
                    </td>
                </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <?php if (@$errmsg_class != "danger") { ?>
            <button class="btn btn-sm btn-default btn-danger manageRequest" data-action='reject'><i
                        class="fa fa-times"></i> <?php print _('Reject'); ?></button>
            <button class="btn btn-sm btn-default btn-success manageRequest" data-action='accept'><i
                        class="fa fa-check"></i> <?php print _('Accept'); ?></button>
        <?php } ?>
    </div>
