        ...
        <div class="loginForm row">
            ...
            <?php if (strlen(@$User->settings->siteLoginText) > 0) { ?>
                ...
                <div class="col-xs-12 text-muted text-right"
                     style="margin-bottom:1em;"><?php print $User->settings->siteLoginText; ?></div>
            <?php } ?>

            <!-- username -->
            <div class="col-xs-12"><strong><?php print _('Username'); ?></strong></div>
            <div class="col-xs-12">
                <input type="text" id="username" name="ipamusername" class="login form-control input-sm"
                       placeholder="<?php print _('Username'); ?>" autofocus="autofocus" autocomplete="off"
            ...
            <div class="col-xs-12">
                <input type="password" id="password" name="ipampassword" class="login form-control input-sm"
                       placeholder="<?php print _('Password'); ?>" autocomplete="off" autocorrect="off"
            ...
            if ($cnt > 4) {
                ...
                <div class="col-xs-12">
                    <input id="validate_captcha" type="text" name="captcha"
                           class="login form-control input-sm col-xs-12">
                </div>
                <div class="col-xs-12">
            ...
            <div class="col-xs-12">
                <hr>
                <input type="submit" value="<?php print _('Login'); ?>"
                       class="btn btn-sm btn-default pull-right"></input>
            </div>
