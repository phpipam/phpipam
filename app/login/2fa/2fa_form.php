...
<div id="login">
    ...
    <form name="login_2fs" id="login_2fs" class="form-inline" method="post">
        <div class="loginForm row login_2fs">
            ...
            <div class="col-xs-12">
                <input type="text" id="2fa_code" name="code" class="login form-control input-sm"
                       placeholder="<?php print _('Enter 2fa code'); ?>" autofocus="autofocus" autocomplete="off"
            ...
            <div class="col-xs-12 text-right">
                <div class="btn-group">
                    <a href="<?php print create_link("login"); ?>"
                       class="btn btn-sm btn-default"><?php print _('Login'); ?></a>
