...
if($Upgrade->upgrade_database()===true) {
	# print success
	$Result->show("success", _("Database upgraded successfully!")." <a class='btn btn-sm btn-default' href='".create_link('dashboard')."'>"._("Dashboard")."</a>", false, false, false, false, false, false);
