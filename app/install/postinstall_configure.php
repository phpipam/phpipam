    ...
    <div class="inner install" style="min-height:auto;">
        ...
        <div class="hContent">
            ...
            <div class="text-muted" style="margin:10px;">
                Hi, almost set, lets just set some basic settings. You can change all settings under administration once
                logged in!
            </div>
            <hr>
                ...
                <form name="postinstall" id="postinstall" class="form-inline" method="post">
                    <div class="row" style="margin-top:10px;padding:20px 10px;">
                        ...
                        <div class="col-xs-12 col-md-8">
                            <input type="password" style="width:100%;" name="password1" class="form-control"
                        ...
                        <div class="col-xs-12 col-md-8">
                            <input type="text" style="width:100%;" name="siteTitle" class="form-control"
                                   autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                   value="phpipam">
                        ...
                        <div class="col-xs-12 col-md-8">
                            <input type="text" style="width:100%;" name="siteURL" class="form-control"
                                   autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                   value="<?php print $_SERVER['SCRIPT_URI']; ?>">
                            <div class="text-muted"></div>
                        </div>
                        ...
                        <div class="col-xs-12 text-right" style="margin-top:10px;">
                            ...
                            <div class="btn-block">
                                ...
                                <a class="btn btn-sm btn-default"
                                   href="<?php print create_link("install", "install_automatic", null, null, null, true); ?>"><i
