    ...
    <div class="inner install" style="min-height:auto;">
        ...
        <div class="hContent">
            <div style="padding:10px;">
                ...
                <!-- Back -->
                <a href="<?php print create_link("install"); ?>" class="btn btn-sm btn-default"><i
                            class='fa fa-angle-left'></i> Back</a>
                <!-- Instructions -->
                <div style="margin-top:10px;padding:30px 20px;">
                    For <?php print $title_prefix; ?> with mysqlimport please follow below steps:
                    <hr>
                    <ol>
...
exit</pre>
                        ...
                        if (@$_GET['subnetId'] == "migrate") {
                            ...
                            <li>Finished ! Now login with <strong>Admin/ipamadmin</strong> to webpage<br>
                                <a href="<?php print create_link(null, null, null, null, null, true); ?>"
                                   class="btn btn-sm btn-info">Login</a>
                            </li>
                        <?php } ?>
                    </ol>
                    <hr>
