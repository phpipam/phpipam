    ...
    <div class="inner install" style="min-height:auto;">
        ...
        <div class="hContent">
            ...
            <div class="text-muted" style="margin:10px;">
                Please provide required inputs in below form for automatic database <?php print $title_prefix; ?>, once
                finished click Install database.
                <br>
            ...
            <form name="installDatabase" id="install" class="form-inline" method="post">
                <div class="row" style="margin-top:10px;padding:20px 10px;">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input type="text" style="width:100%;" name="mysqlrootuser" class="form-control"
                               autofocus="autofocus" autocomplete="off" autocorrect="off" autocapitalize="off"
                               spellcheck="false">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input type="password" style="width:100%;" name="mysqlrootpass" class="form-control"
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input type="text" style="width:100%;" name="mysqllocation" class="form-control"
                               autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                               disabled="disabled" value="<?php print $db['host']; ?>">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input type="text" style="width:100%;" name="mysqltable" class="form-control" autocomplete="off"
                               autocorrect="off" autocapitalize="off" spellcheck="false" disabled="disabled"
                               value="<?php print $db['name']; ?>">
                    ...
                    <div class="col-xs-12 col-md-8" style="padding-top:7px;">
                        <a class="btn btn-sm btn-default" id="toggle-advanced"><i class='fa fa-cogs'></i> Show advanced
                            options</a>
                    </div>
                    ...
                    if (@$_GET['subnetId'] == "migrate") {
                        if (!file_exists(dirname(__FILE__) . "/../../db/MIGRATE.sql")) { ?>
                            <div class="col-xs-12">
                                <hr>
                                <div class='alert alert-danger'>Cannot access file db/MIGRATE.sql!</div>
                            </div>
                        <?php }
                    }
                    ?>
                    ...
                    <div class="col-xs-12 text-right" style="margin-top:10px;">
                        ...
                        <div class="btn-block">
                            <!-- Back -->
                            <a class="btn btn-sm btn-default" href="<?php print create_link("install"); ?>"><i
                                        class='fa fa-angle-left'></i> Back</a>
                            <a class="install btn btn-sm btn-info" version="0"><?php print ucwords($text_prefix); ?>
                                phpipam database</a>
                        </div>
                    </div>
