...
if (!isset($found_arp)) {
    $Result->show("danger", _("No new hosts found from ARP scan, MAC address scan will not be performed"), true);
}
...
// if none found via ARP die
if (!isset($found_mac)) {
    $Result->show("danger", _("No MAC address found via MAC address scan"), true);
}
