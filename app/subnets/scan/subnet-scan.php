...
<div class="pContent">
    <table class="table table-noborder table-condensed table-scan">
            ...
            <td>
                <select name="type" id="type" class="form-control input-sm input-w-auto">
                    ...
                    <optgroup label="<?php print _('Discovery scans'); ?>">
                        <option value="scan-icmp" <?php if (@$_COOKIE['scantype'] == "scan-icmp") print "selected"; ?>><?php print _('Discovery scans'); ?>
                            : Ping <?php print _('scan'); ?></option>
                        <option value="scan-telnet" <?php if (@$_COOKIE['scantype'] == "scan-telnet") print "selected"; ?>><?php print _('Discovery scans'); ?>
                            : Telnet <?php print _('scan'); ?></option>
                        <option value="snmp-route-all" <?php if (@$_COOKIE['scantype'] == "snmp-route-all") print "selected"; ?>><?php print _('Discovery scans'); ?>
                            : SNMP nested subnets <?php print _('scan'); ?></option>
                        <option value="scan-snmp-arp" <?php if (@$_COOKIE['scantype'] == "scan-snmp-arp") print "selected"; ?>><?php print _('Discovery scans'); ?>
                            : SNMP ARP <?php print _('scan'); ?></option>
                        <option value="snmp-mac" <?php if (@$_COOKIE['scantype'] == "snmp-mac") print "selected"; ?>><?php print _('Discovery scans'); ?>
                            : SNMP MAC address <?php print _('scan'); ?></option>
                    </optgroup>
                    <!-- Status update scans -->
                    <optgroup label="<?php print _('Status update scans'); ?>">
                        <option value="update-icmp" <?php if (@$_COOKIE['scantype'] == "update-icmp") print "selected"; ?>><?php print _('Status update scans'); ?>
                            : Ping <?php print _('scan'); ?></option>
                        <option value="update-snmp-arp" <?php if (@$_COOKIE['scantype'] == "update-snmp-arp") print "selected"; ?>><?php print _('Status update scans'); ?>
                            : SNMP ARP <?php print _('scan'); ?></option>
                    </optgroup>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="telnetports" class="form-control input-sm input-w-200"
                       placeholder="<?php print _("Separate multiple ports with ;"); ?>">
            </td>
        </tr>
        </tbody>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default btn-success" id="subnetScanSubmit"
                data-subnetId='<?php print $_POST['subnetId']; ?>' data-csrf-cookie='<?php print $csrf; ?>'><i
                    class="fa fa-gears"></i> <?php print _('Scan subnet'); ?></button>
    </div>
