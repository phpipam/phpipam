			...
			if($show) {
				...
				elseif( $subnet_permission > 1) {
					...
					else
					{
						...
						print "<a class='info_ipaddress   btn btn-xs btn-default' data-subnetId='".$addresses[$n]->subnetId."' data-id='".$addresses[$n]->id."' href='#' rel='tooltip' data-container='body' title='"._('Show Info')."'>
