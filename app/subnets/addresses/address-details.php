...
if(sizeof($address)>1) {
	...
	if( $subnet_permission > 1) {
		...
		else
		{
			...
			print "     <a class='info_ipaddress   btn btn-default btn-xs' data-subnetId='".$address['subnetId']."' data-id='".$address['id']."' href='#'                                                                           rel='tooltip' data-container='body' title='"._('Show Info')."'>                                 <i class='fa fa-gray fa-info-circle'></i></a>";
