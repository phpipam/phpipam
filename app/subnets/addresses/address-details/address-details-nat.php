...
if(isset($all_nats_per_object['ipaddresses'][$address['id']])) {
    foreach ($all_nats_per_object['ipaddresses'][$address['id']] as $nat) {
            ...
            $sources      = $Tools->translate_nat_objects_for_display ($n->src, NULL, NULL, "ipaddresses", $address['id']);
            $destinations = $Tools->translate_nat_objects_for_display ($n->dst, NULL, NULL, "ipaddresses", $address['id']);
