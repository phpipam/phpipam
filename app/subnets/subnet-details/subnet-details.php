...
<table class="ipaddress_subnet table-condensed table-full">
    <tr>
        ...
        <td><span style="font-size:14px;border:1px solid #ccc;background:white;padding:4px 8px;border-radius:3px;"
                  class='subnet_badge'><?php print "<b>" . $Subnets->transform_address($subnet["subnet"], "dotted") . "/$subnet[mask]</b> ($subnet_detailed[netmask])"; ?></span> <?php print $multicast_badge; ?>
        </td>
    </tr>
    <?php
    ...
    <?php if ($subnet_permission == 3) { ?>
        <tr>
    		...
    		<?php
            if (strlen($subnet['editDate']) > 1) {
                print $subnet['editDate'];
            } else {
                print "Never";
            }
            ?>
    ...
    if (!$slaves) {
        ...
        if ($subnet_permission == 3) {
            ...
            if ($subnet['pingSubnet'] == 1) {
                print "	<td><span class='badge badge1 badge5 alert-success'>" . _('enabled') . "</span> $last_check_s</td>";
            }        # yes
            else {
                print "	<td><span class='badge badge1 badge5'>" . _('disabled') . "</span></td>";
            }        # no
            ...
            if ($subnet['discoverSubnet'] == 1) {
                print "	<td><span class='badge badge1 badge5 alert-success'>" . _('enabled') . "</span> $last_check_d</td>";
            }        # yes
            else {
                print "	<td><span class='badge badge1 badge5'>" . _('disabled') . "</span></td>";
            }        # no
