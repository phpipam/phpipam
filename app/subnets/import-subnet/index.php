...
<div class="pContent">
    ...
    # set standard fields
    $standard_fields = ["ip address", "ip state", "description", "hostname", "fw_object", "mac", "owner", "device", "port", "notes", "location"];
    ...
    <form id="csvimport" method="post" action="app/subnets/import-subnet/import-verify.php"
    ...
    <!-- import button -->
    <input type="button" class="btn btn-sm btn-default" value="<?php print _('Show uploaded subnets'); ?>"
           id="csvimportcheck">
