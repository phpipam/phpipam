...
<div class="container-fluid" style='padding-top:5px'>
    <table class="table table-condensed table-hover statistics">
        ...
        <tr>
            ...
            <td class='stats-badge'><span
                        class='badge badge1 badge5'><?php print $Database->numObjects("sections"); ?></span></td>
        </tr>
        ...
        <tr>
            ...
            <td class='stats-badge'><span
                        class='badge badge1 badge5'><?php print $Database->numObjects("subnets");; ?></span></td>
        </tr>
        ...
        <?php if ($User->get_module_permissions("vlan") > 0) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("vlans");; ?></span></td>
            </tr>
        <?php } ?>
        ...
        <?php if ($User->get_module_permissions("vrf") > 0) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("vrf");; ?></span></td>
            </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td class='stats-badge'><span
                        class='badge badge1 badge5'><?php print $Tools->count_subnets("IPv4"); ?></span></td>
        </tr>
        ...
        <tr>
            ...
            <td class='stats-badge'><span
                        class='badge badge1 badge5'><?php print $Tools->count_subnets("IPv6"); ?></span></td>
        </tr>
        ...
        <?php if ($User->get_module_permissions("devices") > 0) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("devices"); ?></span></td>
            </tr>
        <?php } ?>
        ...
        <?php if ($User->get_module_permissions("locations") > 0) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("locations"); ?></span></td>
            </tr>
        <?php } ?>
        ...
        <?php if ($User->get_module_permissions("racks") > 0) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("racks"); ?></span></td>
            </tr>
        <?php } ?>
        ...
        <?php if ($User->is_admin(false)) { ?>
            <tr>
                ...
                <td class='stats-badge'><span
                            class='badge badge1 badge5'><?php print $Database->numObjects("users"); ?></span></td>
            </tr>
        <?php } ?>
