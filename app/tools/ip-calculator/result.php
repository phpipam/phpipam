...
<table class="ipCalcResult table table-striped table-condensed table-noborder table-hover">
    ...
    <tr>
        ...
        <td style="padding-top:10px">
            <button id="createSubnetFromCalc" class="btn btn-sm btn-default"><i
                        class="fa fa-check"></i> <?php print _('Create subnet from result'); ?></button>
        </td>
    </tr>
    ...
    <tr id="selectSection" style="display:none">
        ...
        <td>
            <select name="selectSectionfromIPCalc" id="selectSectionfromIPCalc" class="form-control"
                    style="width:auto;">
