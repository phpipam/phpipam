...
<?php if ($User->get_module_permissions("vlan") > 2) { ?>
    <div class="btn-group" style="margin-bottom:10px;">
        <button class='btn btn-sm btn-default open_popup' data-script='app/admin/vlans/edit-domain.php' data-class='700'
                data-action='add'><i class='fa fa-plus'></i> <?php print _('Add L2 Domain'); ?></button>
        <button class='btn btn-sm btn-default open_popup' data-script='app/admin/vlans/edit.php' data-class='500'
                data-action='add'><i class='fa fa-plus'></i> <?php print _('Add VLAN'); ?></button>
    </div>
<?php } ?>


<table class="table sorted nosearch nopagination table-striped table-top table-condensed table-auto-wide"
       data-cookie-id-table='tools_l2_all'>
    <!-- headers -->
    <thead>
    <tr>
    ...
    <!-- all domains -->
    <tr>
        <td class='border-bottom'><strong><a
                        href="<?php print create_link($_GET['page'], $_GET['section'], "all"); ?>"> <?php print _('All domains'); ?></a></strong>
        </td>
        ...
        <td class='border-bottom'><a class='btn btn-xs btn-default'
                                     href='<?php print create_link($_GET['page'], $_GET['section'], "all"); ?>'>Show
                VLANs</a></td>
        <?php if ($User->get_module_permissions("vlan") > 1) { ?>
            <td class='border-bottom'></td><?php } ?>
    </tr>
