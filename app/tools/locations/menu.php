...
<!-- Add link -->
<a href="" class='btn btn-sm btn-success open_popup' data-script='app/admin/locations/edit.php' data-action='add'
   data-id='' data-action='add' style='margin-bottom:10px;'><i class='fa fa-plus'></i> <?php print _('Add location'); ?>
</a>
