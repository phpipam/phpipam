        ...
        <table id="requestIP" class="table table-condensed">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <input type="text" name="ip_addr" class="ip_addr form-control" size="30"
            ...
            <tr>
                ...
                <td><input class="form-control" type="text" name="description" size="30"
                           placeholder="<?php print _('Enter description'); ?>"></td>
            </tr>

            <!-- DNS name -->
            <tr>
                <td><?php print _('DNS name'); ?></td>
                <td><input type="text" class="form-control" name="hostname" size="30"
                           placeholder="<?php print _('hostname'); ?>"></td>
            </tr>
            ...
            <tr class="owner">
                ...
                <td>
                    <!-- autocomplete -->
                    <input type="text" class="form-control" name="owner" id="owner" size="30"
                           placeholder="<?php print _('Owner of IP address'); ?>"
                           value="<?php print @$User->user->real_name; ?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="requester" size="30"
                           placeholder="<?php print _('your email address'); ?>"
                           value="<?php print @$User->user->email; ?>"></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding-right:20px;">
                    <textarea name="comment" class="form-control" rows="2" style="width:100%;"
                              placeholder="<?php print _('Enter additional details for request if they are needed'); ?>"></textarea>
                </td>
            </tr>
