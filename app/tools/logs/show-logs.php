...
<table id="logs" class="table sorted nosearch nopagination table-condensed table-hover table-top"
       style="margin-top:10px;" data-cookie-id-table="show_logs">
...
<?php if (sizeof($logs) == 0) {
    $Result->show("info", _('No logs available') . "!", true);
} ?>