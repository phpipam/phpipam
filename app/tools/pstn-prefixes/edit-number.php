    ...
    <form id="editPSTNnumber">
        <table id="editPSTNnumber" class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="number" style="width:100px;"
                           value="<?php print $number->number; ?>"
                           placeholder='<?php print _('Number'); ?>' <?php print $readonly; ?>>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="name"
                           value="<?php print $Tools->strip_xss($number->name); ?>"
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="owner"
                           value="<?php print $Tools->strip_xss($number->owner); ?>"
                           placeholder='<?php print _('Owner'); ?>' <?php print $readonly; ?>>
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <textarea class="form-control input-sm" name="description"
                              placeholder='<?php print $number->description; ?>' <?php print $readonly; ?>><?php print $number->description; ?></textarea>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editPSTNnumberSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
