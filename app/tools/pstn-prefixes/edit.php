    ...
    <form id="editPSTN">
        <table id="editPSTN" class="table table-noborder table-condensed">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="name"
                           value="<?php print $Tools->strip_xss($prefix->name); ?>"
                           placeholder='<?php print _('Name'); ?>' <?php print $readonly; ?>>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="prefix"
                           value="<?php print $Tools->strip_xss($prefix->prefix); ?>"
                           placeholder='<?php print _('Prefix'); ?>' <?php print $readonly; ?>>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="start" style="width:70px;"
                           value="<?php print $prefix->start; ?>"
                           placeholder='<?php print _('Start'); ?>' <?php print $readonly; ?>>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm" name="stop" style="width:70px;"
                           value="<?php print $prefix->stop; ?>"
                           placeholder='<?php print _('Stop'); ?>' <?php print $readonly; ?>>
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <textarea class="form-control input-sm" name="description"
                              placeholder='<?php print $prefix->description; ?>' <?php print $readonly; ?>><?php print $prefix->description; ?></textarea>
                </td>
            </tr>
...
<div class="pFooter">
    <div class="btn-group">
        ...
        <button class="btn btn-sm btn-default <?php if ($_POST['action'] == "delete") {
            ...
            print "btn-success";
        } ?>" id="editPSTNSubmit"><i class="fa <?php if ($_POST['action'] == "add") {
                print "fa-plus";
