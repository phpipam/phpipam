...
$custom_address_fields = $GET->addresses=="on" ? $Tools->fetch_custom_fields ("ipaddresses") : [];
$hidden_address_fields = isset($hidden_fields['ipaddresses']) ? $hidden_fields['ipaddresses'] : [];
