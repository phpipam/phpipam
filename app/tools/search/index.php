...
<form id="search" name="search" class='form-inline' role="form" style="margin-bottom:20px;">
	...
	<div class='form-group'>
		<input class="search input-md form-control" name="ip" value="<?php print htmlspecialchars((string) $searchTerm, ENT_QUOTES, 'UTF-8'); ?>" placeholder="<?php print _('Search term'); ?>" type="text" autofocus="autofocus" style='width:250px;'>
	...
	<div style="margin:5px;">
		...
		<input type="checkbox" name="devices" 	    value="on" <?php if($GET->devices=="on") 	{ print "checked='checked'"; } ?>> <?php print _('Devices'); ?>
		<?php } ?>
	</div>
</form>
