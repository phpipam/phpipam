...
if (isset($error)) { ?>
    ...
    <div class="btn-group">
        <a href='javascript:history.back()' class='btn btn-sm btn-default' style='margin-bottom:10px;'><i
                    class='fa fa-chevron-left'></i> <?php print _('Racks'); ?></a>
    </div>
    <br>
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <table class="ipaddress_subnet table-condensed table-auto">
                ...
                <?php if ($User->settings->enableLocations == 1 && strlen($rack->location) > 0 && $rack->location != 0) { ?>
                    <tr>
                        <td colspan='2' style="padding-top:50px !important;">
                            <hr>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <?php if ($rack->hasBack != "0") { ?>
                                <img src="<?php print $Tools->create_rack_link($rack->id, null, true); ?>"
