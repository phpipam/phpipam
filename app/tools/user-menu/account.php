    ...
    <table id="userModSelf" class="table table-condensed">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control input-sm" name="real_name"
                       value="<?php print $User->user->real_name; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="email" class="form-control input-sm" name="email"
                       value="<?php print $User->user->email; ?>" autocomplete="off">
            </td>
        ...
        if ($User->user->authMethod == 1) {
            ...
            <tr>
                ...
                <td class="info2"><?php print _('Password'); ?>
                    <button id="randomPassSelf" class="btn btn-xs btn-default"><i class="fa fa-gray fa-random"></i>
                    </button>
                    <span id="userRandomPass" style="padding-left:15px;"></span></td>
            </tr>
        ...
        <tr>
            ...
            <td>
                <select name="mailNotify" class="form-control input-sm input-w-auto">
                    ...
                    <option value="Yes" <?php if ($User->user->mailNotify == "Yes") {
        ...
        <tr>
            ...
            <td>
                <select name="mailChangelog" class="form-control input-sm input-w-auto">
                    <option value="No"><?php print _("No"); ?></option>
                    <option value="Yes" <?php if ($User->user->mailChangelog == "Yes") {
                        print "selected='selected'";
                    } ?>><?php print _("Yes"); ?></option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="Uncompress" class="input-switch"
                       name="compressOverride" <?php if ($User->user->compressOverride == "Uncompress") print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="hideFreeRange" <?php if ($User->user->hideFreeRange == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" value="1" class="input-switch"
                       name="menuCompact" <?php if ($User->user->menuCompact == 1) print 'checked'; ?>>
            </td>
            <td class="info2">
        ...
        <tr class="th">
            ...
            <td class="submit">
                <input type="submit" class="btn btn-sm btn-success pull-right"
                       value="<?php print _('Save changes'); ?>">
            </td>
            <td></td>
        </tr>
