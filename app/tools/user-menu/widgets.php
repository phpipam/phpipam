...
if ($User->user->role == "Administrator") {
    $widgets = $Tools->fetch_widgets(true, false);
} else {
    $widgets = $Tools->fetch_widgets(false, false);
}
...
<button class='btn btn-sm btn-default' id="submitWidgets"><i class="fa fa-check"></i> <?php print _('Save order'); ?>
</button>
